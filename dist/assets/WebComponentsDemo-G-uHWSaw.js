import{r as x,j as e,L as c}from"./index-LBJNeHTL.js";function p(){const[t,a]=x.useState(null);x.useEffect(()=>{customElements.get("ux4g-demo-button")},[]);const s=(d,o)=>{navigator.clipboard.writeText(d),a(o),setTimeout(()=>a(null),2e3)},l=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
