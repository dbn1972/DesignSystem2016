import{j as e}from"./index-LBJNeHTL.js";import{C as a}from"./ComponentDocumentation-DvEedSJi.js";import"./copy-dn9avyEa.js";import"./info-Cuapm3Yw.js";import"./external-link-BMCrsasL.js";const t=({maxWidth:n="lg"})=>e.jsx("div",{className:`mx-auto px-4 ${n==="sm"?"max-w-2xl":n==="md"?"max-w-4xl":n==="lg"?"max-w-6xl":n==="xl"?"max-w-7xl":"max-w-full"} bg-blue-50 border-2 border-blue-300 border-dashed rounded-lg p-6`,children:e.jsxs("p",{className:"text-center text-gray-700",children:["Container content (",n,")"]})});function l(){return e.jsx(a,{name:"Container",description:"Layout component that centers and constrains content width. Provides consistent horizontal spacing and responsive max-widths for optimal readability across devices.",category:"Layout",maturity:"stable",tier:"foundation",since:"v1.0.0",props:[{name:"maxWidth",type:"'sm' | 'md' | 'lg' | 'xl' | 'full'",default:"'lg'",required:!1,description:"Maximum width constraint for the container."},{name:"children",type:"ReactNode",required:!0,description:"Content to be contained."},{name:"centered",type:"boolean",default:"true",required:!1,description:"Whether to center the container horizontally."},{name:"padding",type:"'none' | 'sm' | 'md' | 'lg'",default:"'md'",required:!1,description:"Horizontal padding inside the container."},{name:"className",type:"string",required:!1,description:"Additional CSS classes."}],examples:[{title:"Container Sizes",description:"Different maximum width constraints.",code:`import { Container } from '@ux4g/react-core';
