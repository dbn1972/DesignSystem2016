...
export default function ResourcesHub() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-br from-orange-50 via-white to-yellow-50 border-b-2 border-gray-300">
        <div className="max-w-[1400px] mx-auto px-12 py-12">
          <div className="max-w-4xl">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-yellow-500 border-2 border-gray-300 rounded flex items-center justify-center">
                <Package size={32} className="text-white" />
              </div>
              <div>
                <div className="text-sm text-gray-600 mb-1">Developer Tools</div>
        ...
        <div className="space-y-8">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <div className="w-6 h-6 bg-[#000080] text-white rounded-full flex items-center justify-center flex-shrink-0 text-xs">1</div>
                    <div>
                  ...
                  <div className="flex items-start gap-2">
                    <div className="w-6 h-6 bg-[#000080] text-white rounded-full flex items-center justify-center flex-shrink-0 text-xs">2</div>
                    <div>
                      <p className="font-bold text-gray-900">Install dependencies</p>
                      <p className="text-gray-600">npm install react-router lucide-react</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-6 h-6 bg-[#000080] text-white rounded-full flex items-center justify-center flex-shrink-0 text-xs">3</div>
                    <div>
                      <p className="font-bold text-gray-900">Start building</p>
                      <p className="text-gray-600">Use components and patterns</p>
                    </div>
                  </div>
                </div>
                <Link
                  to="/resources/starter-kit"
                  className="block w-full mt-6 px-4 py-2 bg-[#000080] hover:bg-[#000066] text-white text-center font-bold rounded transition-colors"
                >
                  View Starter Kit →
                </Link>
              </div>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              ...
              <Link to="/content-system" className="p-4 border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:shadow-md transition-all">
                <h4 className="font-bold text-gray-900 mb-1">Content Design System</h4>
                <p className="text-sm text-gray-700">Standardized labels and messages</p>
              </Link>
              <Link to="/patterns" className="p-4 border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:shadow-md transition-all">
                <h4 className="font-bold text-gray-900 mb-1">Pattern Documentation</h4>
                <p className="text-sm text-gray-700">Design pattern guidelines</p>
              </Link>
              <Link to="/governance" className="p-4 border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:shadow-md transition-all">
                <h4 className="font-bold text-gray-900 mb-1">Governance Guidelines</h4>
                <p className="text-sm text-gray-700">Adoption and compliance tracking</p>
              </Link>
            </div>
          </ResourceSection>
...
function QuickLinkCard({ icon, title, description, path, color }: {
  ...
  return (
    ...
    >
      <div className="mb-3 text-[#000080] group-hover:scale-110 transition-transform">
        {icon}
      </div>
...
function ResourceItem({ title, description, topics, path }: {
  ...
  return (
    <Link
      to={path}
      className="block p-4 border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:shadow-md transition-all group"
    >
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1">
          <h4 className="font-bold text-gray-900 group-hover:text-[#000080] mb-1">{title}</h4>
          <p className="text-sm text-gray-700 mb-3">{description}</p>
        </div>
        <ArrowRight size={20} className="text-gray-400 group-hover:text-[#000080] flex-shrink-0 ml-4" />
      </div>
