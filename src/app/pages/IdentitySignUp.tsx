            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="bg-white border-b-2 border-gray-300 px-8 py-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm text-gray-600">
                    Already have an account? <Link to="/patterns/identity/sign-in" className="text-[#000080] font-bold hover:underline">Sign In</Link>
                  </div>
                </div>
              </div>
                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 mt-2">Enter name exactly as it appears on government ID</div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute left-12 top-1/2 -translate-y-1/2 text-gray-600 font-bold">+91</div>
                        <input
                          type="tel"
                          id="mobile"
                          value={formData.mobile}
                          onChange={(e) => setFormData({ ...formData, mobile: e.target.value })}
                          className="w-full pl-24 pr-4 py-4 border-2 border-gray-300 rounded-lg text-gray-900 focus:border-[#000080] focus:outline-none text-lg font-mono"
                          placeholder="10-digit mobile number"
                          maxLength={10}
                          required
                        />
                      </div>
                      <div className="text-sm text-gray-600 mt-2">You will receive OTP on this number for verification</div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 mt-2">Backup verification method and account recovery</div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-14 py-4 border-2 border-gray-300 rounded-lg text-gray-900 focus:border-[#000080] focus:outline-none text-lg font-mono"
                      ...
                      {password && (
                        <div className="mt-3 bg-gray-50 border-2 border-gray-300 rounded-lg p-4">
                          <div className="text-sm font-bold text-gray-900 mb-3">Password Requirements:</div>
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <label htmlFor="consent" className="text-sm text-gray-700 flex-1">
                          I agree to the <a href="#" className="text-[#000080] font-bold hover:underline">Terms of Service</a> and{" "}
                          <a href="#" className="text-[#000080] font-bold hover:underline">Privacy Policy</a>. I understand my data will be used 
                    ...
                    <div className="pt-4">
                      <Link
                        ...
                        className="block w-full px-8 py-5 bg-[#000080] text-white font-bold rounded-lg hover:bg-[#000060] text-center text-lg transition-colors"
                      >
                  ...
                  <div className="mt-8 bg-green-50 border-l-4 border-green-600 p-4 rounded-r-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-bold text-sm text-gray-900 mb-1">Your data is secure</div>
  ...
  return (
    <div className="border-2 border-gray-300 rounded-lg overflow-hidden bg-white">
      <div className="bg-gray-100 border-b-2 border-gray-300 px-4 py-3">
        <h3 className="font-bold text-gray-900 text-sm">Sign Up Flow</h3>
      </div>
      <div className="p-4">
...
function FlowStep({ number, label, active = false }: { number: string; label: string; active?: boolean }) {
  return (
    <div className={`flex items-center gap-3 p-3 rounded ${active ? 'bg-blue-100 border-2 border-blue-300' : 'bg-gray-50 border-2 border-gray-300'}`}>
      <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${active ? 'bg-[#000080] text-white' : 'bg-gray-300 text-gray-700'}`}>
        {number}
      </div>
  ...
  return (
    <div className="border-2 border-gray-300 rounded-lg overflow-hidden bg-white">
      ...
      <div className="p-4 space-y-4 text-sm text-gray-700">
        ...
        <div>
          <div className="font-bold text-gray-900 mb-1">Email Support</div>
          <div className="text-[#000080] font-bold">support@digitalindia.gov.in</div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-xs">
            <li>• Not receiving OTP? <a href="#" className="text-[#000080] hover:underline">Troubleshoot</a></li>
            <li>• Password requirements? <a href="#" className="text-[#000080] hover:underline">Learn more</a></li>
            <li>• Already registered? <Link to="/patterns/identity/sign-in" className="text-[#000080] hover:underline">Sign in</Link></li>
          </ul>
        </div>
      </div>
    </div>
