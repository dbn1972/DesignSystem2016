    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-gray-900">Service Support Request</span>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 h-0.5 bg-gray-300 mx-2">
              <div className={`h-full bg-[#138808] ${step !== 'select' ? 'w-full' : 'w-0'}`}></div>
            </div>
            <StepIndicator number={2} label="Details" active={step === 'details'} completed={step === 'issue' || step === 'review' || step === 'success'} />
            <div className="flex-1 h-0.5 bg-gray-300 mx-2">
              <div className={`h-full bg-[#138808] ${step === 'issue' || step === 'review' || step === 'success' ? 'w-full' : 'w-0'}`}></div>
            </div>
            <StepIndicator number={3} label="Issue" active={step === 'issue'} completed={step === 'review' || step === 'success'} />
            <div className="flex-1 h-0.5 bg-gray-300 mx-2">
              <div className={`h-full bg-[#138808] ${step === 'review' || step === 'success' ? 'w-full' : 'w-0'}`}></div>
            </div>
      ...
      <main className="max-w-[1200px] mx-auto px-8 py-12">
        ...
        {step === 'select' && (
          <div className="max-w-[800px] mx-auto">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-3">Service Support Request</h1>
              <p className="text-gray-600">Get help with ongoing services or applications</p>
            </div>

            <div className="bg-white border-2 border-gray-300 rounded-lg p-8 mb-6">
              <h2 className="font-bold text-gray-900 mb-4">Do you have an existing application or reference ID?</h2>
              <div className="space-y-3">
                <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-gray-400 transition-all"
                  ...
                  />
                  <div>
                    <div className="font-bold text-gray-900">Yes, I have a reference ID</div>
                    <div className="text-sm text-gray-600">For existing applications or previous requests</div>
                  </div>
                </label>
                <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:border-gray-400 transition-all"
                  ...
                  />
                  <div>
                    <div className="font-bold text-gray-900">No, this is a new support request</div>
                    <div className="text-sm text-gray-600">For general service support or technical issues</div>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-8 py-3 bg-[#000080] text-white rounded font-bold disabled:bg-gray-400 flex items-center gap-2"
              >
        ...
        {step === 'details' && (
          <div className="max-w-[800px] mx-auto">
            ...
            <div className="flex justify-between">
              <button onClick={() => setStep('select')} className="px-6 py-3 border-2 border-gray-300 rounded font-bold flex items-center gap-2">
                <ArrowLeft size={20} /> Back
              </button>
              <button onClick={() => setStep('issue')} className="px-8 py-3 bg-[#000080] text-white rounded font-bold flex items-center gap-2">
                Continue <ArrowRight size={20} />
              </button>
            </div>
          </div>
        ...
        {step === 'issue' && (
          <div className="max-w-[800px] mx-auto">
            <div className="bg-white border-2 border-gray-300 rounded-lg p-8 mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Describe Your Issue</h2>
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-2">Service Category <span className="text-red-600">*</span></label>
                ...
                {formData.serviceCategory && (
                  <div>
                    <label className="block text-sm font-bold text-gray-900 mb-2">Issue Type <span className="text-red-600">*</span></label>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-2">Detailed Description <span className="text-red-600">*</span></label>
                  <textarea rows={6} value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded" placeholder="Please describe the issue in detail..." />
                  {errors.description && <p className="mt-1 text-sm text-red-600">{errors.description}</p>}
                </div>

                <div>
                  <label className="block text-sm font-bold text-gray-900 mb-2">Attachment (Optional)</label>
            ...
            <div className="flex justify-between">
              <button onClick={() => setStep('details')} className="px-6 py-3 border-2 border-gray-300 rounded font-bold flex items-center gap-2">
                <ArrowLeft size={20} /> Back
              </button>
              <button onClick={() => setStep('review')} className="px-8 py-3 bg-[#000080] text-white rounded font-bold flex items-center gap-2">
        ...
        {step === 'review' && (
          <div className="max-w-[800px] mx-auto">
            <div className="bg-white border-2 border-gray-300 rounded-lg p-8 mb-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Review Request</h2>
            ...
            <div className="flex justify-between">
              <button onClick={() => setStep('issue')} className="px-6 py-3 border-2 border-gray-300 rounded font-bold flex items-center gap-2">
                <ArrowLeft size={20} /> Edit
              </button>
              <button onClick={handleSubmit} className="px-8 py-3 bg-[#138808] text-white rounded font-bold flex items-center gap-2">
        ...
        {step === 'success' && (
          <div className="max-w-[800px] mx-auto">
            <div className="bg-white border-2 border-green-300 rounded-lg p-12 text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Support Request Submitted!</h2>
              <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6 mb-6">
                <div className="text-sm text-gray-600 mb-2">Support Ticket ID</div>
                <div className="text-3xl font-bold text-[#000080] font-mono">{referenceNumber}</div>
              </div>
              ...
              <Link to="/patterns/contact-support" className="inline-block px-6 py-3 bg-[#000080] text-white rounded font-bold">
                Back to Patterns
              </Link>
            </div>
          </div>
  ...
  return (
    <div>
      ...
      <input type={type} value={value} onChange={(e) => onChange(e.target.value)} placeholder={placeholder}
        className={`w-full px-4 py-3 border-2 rounded ${error ? 'border-red-500' : 'border-gray-300'}`} />
