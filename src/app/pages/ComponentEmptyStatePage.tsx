...
const EMPTYSTATE_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'showAction', label: 'Show Action', type: 'boolean', defaultValue: false },
  { name: 'showIllustration', label: 'Show Illustration', type: 'boolean', defaultValue: false },
];
...
function EmptyStatePlayground() {
  return (
    <ComponentPlayground
      name="EmptyState"
      controls={EMPTYSTATE_PLAYGROUND_CONTROLS}
      renderPreview={(v) => (
        <div className="w-full flex items-center justify-center">
          <EmptyStatePreview title="No applications yet" description="Start your first application" actionLabel={v.showAction ? "Get Started" : undefined} />
        </div>
      )}
      codeTemplate={(v) =>
        `<EmptyState${v.showAction ? ' showAction' : ''}${v.showIllustration ? ' showIllustration' : ''} />`
      }
    />
  );
}
      ...
      props={[
        {
          ...
          type: 'string',
          required: true,
          description: 'Primary heading text describing the empty state.',
        },
        {
          name: 'description',
          type: 'string',
        ...
        },
        {
          ...
          type: 'ReactNode',
          required: false,
          description: 'Secondary action element.',
        },
        {
          name: 'size',
          type: "'sm' | 'md' | 'lg'",
