    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live MapLocationPicker preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {editable && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">editable</span>}
...
export default function ComponentMapLocationPickerPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Ma</div>
          <p className="text-sm text-muted-foreground">MapLocationPicker component in its default state</p>
        </div>
      }
