...
import ApprovalIssuancePattern from '../ApprovalIssuancePattern';
...
describe('ApprovalIssuancePattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ApprovalIssuancePattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ApprovalIssuancePattern />);
