...
import ApplicationSubmissionPattern from '../ApplicationSubmissionPattern';
...
describe('ApplicationSubmissionPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ApplicationSubmissionPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ApplicationSubmissionPattern />);
