...
import NotificationCenterPattern from '../NotificationCenterPattern';
...
describe('NotificationCenterPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<NotificationCenterPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<NotificationCenterPattern />);
