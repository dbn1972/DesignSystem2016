...
import ActionableNotificationsPattern from '../ActionableNotificationsPattern';
...
describe('ActionableNotificationsPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ActionableNotificationsPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ActionableNotificationsPattern />);
