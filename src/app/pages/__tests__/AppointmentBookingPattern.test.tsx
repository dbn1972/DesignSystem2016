...
import AppointmentBookingPattern from '../AppointmentBookingPattern';
...
describe('AppointmentBookingPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<AppointmentBookingPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<AppointmentBookingPattern />);
