...
import ConsentDeclarationPatterns from '../ConsentDeclarationPatterns';
...
describe('ConsentDeclarationPatterns', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ConsentDeclarationPatterns />);
