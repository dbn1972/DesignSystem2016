...
import NoResultsPattern from '../NoResultsPattern';
...
describe('NoResultsPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<NoResultsPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<NoResultsPattern />);
