...
import ServiceSupportPattern from '../ServiceSupportPattern';
...
describe('ServiceSupportPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ServiceSupportPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ServiceSupportPattern />);
