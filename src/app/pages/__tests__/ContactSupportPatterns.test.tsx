...
import ContactSupportPatterns from '../ContactSupportPatterns';
...
describe('ContactSupportPatterns', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ContactSupportPatterns />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ContactSupportPatterns />);
