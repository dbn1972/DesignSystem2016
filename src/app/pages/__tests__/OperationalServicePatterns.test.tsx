...
import OperationalServicePatterns from '../OperationalServicePatterns';
...
describe('OperationalServicePatterns', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<OperationalServicePatterns />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<OperationalServicePatterns />);
