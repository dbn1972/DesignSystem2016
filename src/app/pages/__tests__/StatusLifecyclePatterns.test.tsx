...
import StatusLifecyclePatterns from '../StatusLifecyclePatterns';
...
describe('StatusLifecyclePatterns', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<StatusLifecyclePatterns />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<StatusLifecyclePatterns />);
