...
import ServicePatternLibraries from '../ServicePatternLibraries';
...
describe('ServicePatternLibraries', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ServicePatternLibraries />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ServicePatternLibraries />);
