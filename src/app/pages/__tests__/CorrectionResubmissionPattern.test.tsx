...
import CorrectionResubmissionPattern from '../CorrectionResubmissionPattern';
...
describe('CorrectionResubmissionPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<CorrectionResubmissionPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<CorrectionResubmissionPattern />);
