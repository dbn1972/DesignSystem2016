...
import ComplaintEscalationPattern from '../ComplaintEscalationPattern';
...
describe('ComplaintEscalationPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ComplaintEscalationPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ComplaintEscalationPattern />);
