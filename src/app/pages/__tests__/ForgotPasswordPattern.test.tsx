...
import ForgotPasswordPattern from '../ForgotPasswordPattern';
...
describe('ForgotPasswordPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<ForgotPasswordPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<ForgotPasswordPattern />);
