...
import EligibilityScreeningPattern from '../EligibilityScreeningPattern';
...
describe('EligibilityScreeningPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<EligibilityScreeningPattern />);
