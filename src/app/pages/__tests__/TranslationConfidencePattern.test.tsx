...
import TranslationConfidencePattern from '../TranslationConfidencePattern';
...
describe('TranslationConfidencePattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<TranslationConfidencePattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<TranslationConfidencePattern />);
