...
import OTPVerificationPattern from '../OTPVerificationPattern';
...
describe('OTPVerificationPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<OTPVerificationPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<OTPVerificationPattern />);
