...
import IdentityAccessPatterns from '../IdentityAccessPatterns';
...
describe('IdentityAccessPatterns', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<IdentityAccessPatterns />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<IdentityAccessPatterns />);
