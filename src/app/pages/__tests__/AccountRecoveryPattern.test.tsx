...
import AccountRecoveryPattern from '../AccountRecoveryPattern';
...
describe('AccountRecoveryPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<AccountRecoveryPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<AccountRecoveryPattern />);
