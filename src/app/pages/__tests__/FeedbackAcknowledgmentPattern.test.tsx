...
import FeedbackAcknowledgmentPattern from '../FeedbackAcknowledgmentPattern';
...
describe('FeedbackAcknowledgmentPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<FeedbackAcknowledgmentPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<FeedbackAcknowledgmentPattern />);
