...
import AadhaarAuthenticationPattern from '../AadhaarAuthenticationPattern';
...
describe('AadhaarAuthenticationPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<AadhaarAuthenticationPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<AadhaarAuthenticationPattern />);
