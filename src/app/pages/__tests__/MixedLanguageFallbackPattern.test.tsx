...
import MixedLanguageFallbackPattern from '../MixedLanguageFallbackPattern';
...
describe('MixedLanguageFallbackPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<MixedLanguageFallbackPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<MixedLanguageFallbackPattern />);
