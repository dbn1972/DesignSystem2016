...
import PostCompletionFeedbackPattern from '../PostCompletionFeedbackPattern';
...
describe('PostCompletionFeedbackPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<PostCompletionFeedbackPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<PostCompletionFeedbackPattern />);
