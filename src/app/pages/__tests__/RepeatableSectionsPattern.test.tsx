...
import RepeatableSectionsPattern from '../RepeatableSectionsPattern';
...
describe('RepeatableSectionsPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<RepeatableSectionsPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<RepeatableSectionsPattern />);
