...
import AssistedOfflineOnlinePattern from '../AssistedOfflineOnlinePattern';
...
describe('AssistedOfflineOnlinePattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<AssistedOfflineOnlinePattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<AssistedOfflineOnlinePattern />);
