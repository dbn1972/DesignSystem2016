...
import LanguageSwitcherPattern from '../LanguageSwitcherPattern';
...
describe('LanguageSwitcherPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<LanguageSwitcherPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<LanguageSwitcherPattern />);
