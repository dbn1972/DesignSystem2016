...
import IssueReportingPattern from '../IssueReportingPattern';
...
describe('IssueReportingPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<IssueReportingPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<IssueReportingPattern />);
