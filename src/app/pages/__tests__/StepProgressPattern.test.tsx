...
import StepProgressPattern from '../StepProgressPattern';
...
describe('StepProgressPattern', () => {
  // ── Smoke ─────────────────────────────────────────────────────────
  it('renders without crashing', () => {
    renderWithRouter(<StepProgressPattern />);
  ...
  it('has no axe accessibility violations', async () => {
    const { container } = renderWithRouter(<StepProgressPattern />);
