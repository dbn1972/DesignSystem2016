...
export default function CompanyRegOfficerDashboard() {
  const stats = {
    totalCases: 34,
    pendingReview: 9,
    underReview: 6,
  ...
  const recentActivity = [
    { action: "CIN Generated", refNumber: "MCA-2026-REG-876543", applicant: "Priya Sharma", time: "20 minutes ago", type: "success" as const },
    { action: "Clarification Requested", refNumber: "MCA-2026-REG-875421", applicant: "Rajesh Kumar", time: "1 hour ago", type: "warning" as const },
    { action: "New Application Assigned", refNumber: "MCA-2026-REG-874112", applicant: "Anita Desai", time: "2 hours ago", type: "info" as const },
    { action: "Name Approved", refNumber: "MCA-2026-REG-873098", applicant: "Vikram Singh", time: "3 hours ago", type: "success" as const },
  ];

  const urgentCases = [
    { refNumber: "MCA-2026-REG-872567", applicant: "Meera Patel", entityType: "Private Limited", daysWaiting: 14 },
    { refNumber: "MCA-2026-REG-871234", applicant: "Arjun Reddy", entityType: "LLP", daysWaiting: 12 },
    { refNumber: "MCA-2026-REG-870987", applicant: "Kavita Joshi", entityType: "OPC", daysWaiting: 10 },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-muted-foreground">ROC Officer Portal</div>
                <h1 className="text-2xl font-bold text-foreground">Company Registration Dashboard</h1>
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-xs text-muted-foreground">ROC Office, Mumbai</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard icon={<Briefcase size={28} />} label="Total Cases" value={stats.totalCases} color="blue" trend="+2 from yesterday" />
              ...
              <div className="p-6 space-y-4">
                {urgentCases.map((c, i) => (
                  <div key={i} className="bg-red-50 dark:bg-red-950/30 border-2 border-red-300 rounded p-4">
                    ...
                    <div className="text-xs text-muted-foreground mb-2">{c.entityType}</div>
      ...
      <footer className="bg-card border-t-2 border-border mt-24">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-8">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div>Company Registration Service • ROC Officer Portal</div>
            <div>Dashboard</div>
          </div>
        </div>
      </footer>
