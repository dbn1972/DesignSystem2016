...
const TAG_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'variant', label: 'Variant', type: 'select', defaultValue: 'default', options: ['default', 'primary', 'success', 'warning', 'error'] },
  { name: 'removable', label: 'Removable', type: 'boolean', defaultValue: false },
];
    ...
    <ComponentPlayground
      ...
      renderPreview={(v) => (
        <div className="flex flex-wrap gap-2">
          <TagPreview variant={v.variant} closeable={v.removable}>PDF</TagPreview>
          <TagPreview variant="success">Verified</TagPreview>
          <TagPreview variant="warning">Pending</TagPreview>
        </div>
      )}
      codeTemplate={(v) =>
        `<Tag variant="${v.variant}"${v.removable ? ' removable' : ''}>PDF</Tag>`
      }
    />
  );
}
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Categorization labels</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Removable filter chips</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Status or type indicators</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Keyword or tag displays</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Status indicators without removal — use Badge</li>
                  ...
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Long text — use a different layout</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="/components/badge" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
                ...
                <p className="text-sm text-muted-foreground">For non-removable status</p>
              </a>
              ...
              <a href="/components/checkbox" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
                ...
                <p className="text-sm text-muted-foreground">For filter selections</p>
              </a>
            </div>
          </section>
            ...
            <div className="space-y-4">
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added removable variant</li>
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added color options</li>
                  </ul>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <div className="flex items-center gap-3 mb-1">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Initial release with basic tag</li>
                  </ul>
                </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h3 className="font-semibold text-foreground mb-1 text-sm">Removable tags need clear affordance</h3>
                <p className="text-sm text-muted-foreground">Tags with an X icon are 60% more likely to be understood as removable than tags without (Baymard).</p>
              </div>
            </div>
          </section>
        </>
