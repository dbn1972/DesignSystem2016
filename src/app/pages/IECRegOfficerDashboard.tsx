...
export default function IECRegOfficerDashboard() {
  const stats = {
    totalCases: 42,
    pendingReview: 11,
    underReview: 7,
  ...
  const recentActivity = [
    { action: "IEC Issued", refNumber: "DGFT-2026-IEC-876543", applicant: "Priya Sharma", time: "10 minutes ago", type: "success" as const },
    { action: "Clarification Requested", refNumber: "DGFT-2026-IEC-875421", applicant: "Vikram Singh", time: "30 minutes ago", type: "warning" as const },
    { action: "New Application Assigned", refNumber: "DGFT-2026-IEC-874112", applicant: "Anita Desai", time: "1 hour ago", type: "info" as const },
    { action: "Documents Verified", refNumber: "DGFT-2026-IEC-873098", applicant: "Rajesh Kumar", time: "2 hours ago", type: "success" as const },
  ];

  const urgentCases = [
    { refNumber: "DGFT-2026-IEC-872567", applicant: "Meera Patel", entityType: "Pvt. Ltd.", daysWaiting: 5 },
    { refNumber: "DGFT-2026-IEC-871234", applicant: "Arjun Reddy", entityType: "LLP", daysWaiting: 4 },
    { refNumber: "DGFT-2026-IEC-870987", applicant: "Kavita Joshi", entityType: "Proprietorship", daysWaiting: 4 },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-muted-foreground">DGFT Officer Portal</div>
                <h1 className="text-2xl font-bold text-foreground">IEC Registration Dashboard</h1>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-muted-foreground">Logged in as</div>
              <div className="font-bold text-foreground">Officer Neha Kapoor</div>
              <div className="text-xs text-muted-foreground">DGFT Regional Office, Mumbai</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <MetricCard icon={<Clock size={24} />} label="Avg. Processing" value={stats.avgProcessingTime} subtext="Target: 5 days" color="blue" />
      ...
      <footer className="bg-card border-t-2 border-border mt-24">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-8">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div>IEC Registration Service • DGFT Officer Portal</div>
            <div>Dashboard</div>
          </div>
        </div>
      </footer>
