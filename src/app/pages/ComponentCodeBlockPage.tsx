    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live CodeBlock preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {showLineNumbers && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showLineNumbers</span>}
            <span className="px-2 py-0.5 rounded-full text-xs bg-muted text-muted-foreground font-medium">{language}</span>
          </div>
        </div>
      </div>
...
export default function ComponentCodeBlockPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Co</div>
          <p className="text-sm text-muted-foreground">CodeBlock component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          ...
          type: 'string',
          required: true,
          description: 'The code or text content to display. Can be single-line or multi-line.',
        },
        {
          name: 'language',
          type: "'typescript' | 'javascript' | 'json' | 'html' | 'css' | 'python' | 'java' | 'bash' | 'text'",
          default: "'text'",
          required: false,
          description: 'Programming language for syntax highlighting. Used for code snippets and technical documentation.',
        },
        {
          name: 'inline',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Render as inline code within text flow. Use for reference numbers, IDs, and short technical terms.',
        },
        {
          ...
          default: 'false',
          required: false,
          description: 'Display line numbers on the left side. Useful for code review and technical documentation.',
        },
        {
          name: 'showCopyButton',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Show a copy-to-clipboard button. Essential for reference IDs, API keys, and code snippets.',
        },
        {
          name: 'filename',
          type: 'string',
          required: false,
          description: 'Display a filename or title in the header. Helps identify configuration files or API endpoints.',
        },
        {
          name: 'size',
          type: "'sm' | 'md' | 'lg'",
          default: "'md'",
          required: false,
          description: 'Font size variant. Small (12px), Medium (14px), Large (16px).',
        },
        {
          name: 'maxHeight',
          type: 'string',
          required: false,
          description: 'Maximum height with scrolling. Example: "200px" or "50vh". Prevents long code from dominating the page.',
        },
        {
          name: 'className',
          type: 'string',
          required: false,
          description: 'Additional CSS classes to apply. Merged with component classes.',
        },
      ]}
