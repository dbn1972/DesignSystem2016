...
function DialogPlayground() {
  return (
    <ComponentPlayground
      ...
      renderPreview={(v) => (
        <div className="w-full max-w-lg w-full max-w-sm bg-card border border-border rounded-xl shadow-lg p-6 space-y-4">
          <h3 className={`font-semibold ${v.variantColors[variant] || 'text-foreground'}`}>{v.title}</h3>
    ...
    <ComponentDocumentation
      ...
      preview={
        <div className="w-full max-w-sm bg-card border border-border rounded-xl shadow-lg p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">You will need to sign in again to access your applications.</p>
          <div className="flex justify-end gap-2">
            <button className="px-4 py-2 text-sm border border-border rounded-lg">Cancel</button>
            <button className="px-4 py-2 text-sm bg-[#005196] text-white rounded-lg">Log Out</button>
          </div>
        </div>
      }
      ...
      props={[
        ...
        },
        {
          ...
          type: '() => void',
          required: true,
          description: 'Callback when dialog should close (backdrop click, Escape key, or close button).',
        },
        {
          name: 'title',
          type: 'ReactNode',
          required: false,
          description: 'Dialog title displayed in the header. Used for aria-labelledby.',
        },
        {
          name: 'description',
          type: 'ReactNode',
          required: false,
          description: 'Description text announced by assistive technology. Used for aria-describedby.',
        },
        {
          name: 'children',
          type: 'ReactNode',
        ...
        },
        {
          ...
          type: 'ReactNode',
          required: false,
          description: 'Dialog footer content. Typically action buttons.',
        },
        {
          name: 'size',
          ...
          default: "'md'",
          required: false,
          description: 'Dialog width. sm (384px), md (448px), lg (672px), xl (896px), full (100%).',
        },
        {
        ...
        },
        {
          ...
          required: false,
          description: 'Additional props passed to the dialog content wrapper.',
        },
        {
          name: 'backdropProps',
          type: 'HTMLAttributes<HTMLDivElement>',
          required: false,
          description: 'Additional props passed to the backdrop element.',
        },
        {
          name: 'className',
          type: 'string',
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Simple confirmation prompts</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Warnings before navigation</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Quick decisions not needing full modal</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Complex content — use Modal</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Non-blocking messages — use Toast</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Inline feedback — use Alert</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Scrollable content — use Modal</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="/components/modal" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
                ...
                <p className="text-sm text-muted-foreground">For complex overlays</p>
              </a>
            ...
            <div className="space-y-4">
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added warning variant</li>
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added custom footer</li>
                  </ul>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <div className="flex items-center gap-3 mb-1">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Initial release with confirm/cancel</li>
                  </ul>
                </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h3 className="font-semibold text-foreground mb-1 text-sm">Confirmation reduces errors</h3>
                <p className="text-sm text-muted-foreground">Confirmation dialogs reduce accidental deletions by 67% (Baymard).</p>
              </div>
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h3 className="font-semibold text-foreground mb-1 text-sm">Clear action labels</h3>
                <p className="text-sm text-muted-foreground">GOV.UK recommends specific labels over generic OK/Cancel.</p>
              </div>
            </div>
          </section>
        </>
