    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live CalendarScheduler preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            <span className="px-2 py-0.5 rounded-full text-xs bg-muted text-muted-foreground font-medium">{view}</span>
          </div>
        </div>
      </div>
...
export default function ComponentCalendarSchedulerPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Ca</div>
          <p className="text-sm text-muted-foreground">CalendarScheduler component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          ...
          default: "'month'",
          required: false,
          description: 'Calendar view mode. Month view shows full month grid, week view shows hourly slots for 7 days, day view shows detailed hourly timeline for single day.',
        },
        {
          name: 'events',
          type: 'CalendarEvent[]',
          required: false,
          description: 'Array of calendar events to display. Each event includes id, title, start, end, description, location, department, and color.',
        },
        {
          name: 'onSelectSlot',
          type: '(slotInfo: { start: Date; end: Date; view: string }) => void',
          required: false,
          description: 'Callback when a time slot is clicked. Used for creating new appointments or events.',
        },
        {
          name: 'onSelectEvent',
          type: '(event: CalendarEvent) => void',
          required: false,
          description: 'Callback when an existing event is clicked. Used for viewing or editing event details.',
        },
        {
          name: 'minTime',
          type: 'string',
          default: "'08:00'",
          required: false,
          description: 'Earliest time slot visible in day/week view. Format: HH:mm (24-hour).',
        },
        {
          name: 'maxTime',
          type: 'string',
          default: "'18:00'",
          required: false,
          description: 'Latest time slot visible in day/week view. Format: HH:mm (24-hour).',
        },
        {
          name: 'workingHours',
          type: '{ start: string; end: string; days: number[] }',
          required: false,
          description: 'Define working hours and days. Days array: 0=Sunday, 1=Monday, etc. Non-working hours are visually distinguished.',
        },
        {
          name: 'holidays',
          type: 'Date[]',
          required: false,
          description: 'Array of holiday dates. These dates are marked and typically non-bookable.',
        },
        {
          name: 'enableBooking',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Enable appointment booking interface. Shows available slots and booking confirmation flow.',
        },
        {
          name: 'slotDuration',
          type: 'number',
          default: '30',
          required: false,
          description: 'Duration of time slots in minutes. Common values: 15, 30, 60.',
        },
        {
          name: 'departments',
          type: 'Department[]',
          required: false,
          description: 'Array of departments/resources for multi-resource scheduling. Each has id, name, color, and availability.',
        },
        {
          name: 'locale',
          type: 'string',
          default: "'en-US'",
          required: false,
          description: 'Locale for date formatting and translations. Supports all valid BCP 47 language tags.',
        },
        {
          name: 'timezone',
          type: 'string',
          ...
          required: false,
          description: 'IANA timezone identifier for proper time display and scheduling.',
        },
        {
          name: 'className',
          type: 'string',
        ...
        {
          name: 'onViewChange',
          type: "(view: 'month' | 'week' | 'day') => void",
          required: false,
          description: 'Callback when calendar view changes.',
        },
        {
          name: 'onNavigate',
          type: '(date: Date, view: string) => void',
          required: false,
          description: 'Callback when user navigates to different date range.',
        },
      ]}
