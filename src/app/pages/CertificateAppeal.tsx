      ...
      <header className="bg-white border-b-2 border-gray-300">
        <div className="max-w-[1400px] mx-auto px-12 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm text-gray-600">Application Appeal</div>
              <h1 className="text-2xl font-bold text-gray-900">File an Appeal</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto px-12 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 mb-8">
            <h2 className="font-bold text-gray-900 mb-3">About Appeals</h2>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden mb-6">
            <div className="bg-red-50 border-b-2 border-red-300 px-8 py-4">
              <h2 className="font-bold text-gray-900">Rejected Application Details</h2>
            </div>
            <div className="p-8">
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div>
                  <div className="text-xs text-gray-600 mb-1">Reference Number</div>
                  <div className="text-sm font-bold text-gray-900 font-mono">{rejectionData.refNumber}</div>
                </div>
                <div>
              ...
              <div>
                <div className="text-xs text-gray-600 mb-2">Reason for Rejection</div>
                <div className="p-4 bg-red-50 border-2 border-red-300 rounded text-sm text-gray-700">
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden mb-6">
            <div className="bg-gray-100 border-b-2 border-gray-300 px-8 py-4">
              <h2 className="font-bold text-gray-900">Appeal Information</h2>
            </div>
              ...
              <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-5">
                ...
                {formData.newDocuments && (
                  <div className="mt-4 pt-4 border-t-2 border-orange-300">
                    <button className="flex items-center gap-2 px-4 py-3 border-2 border-dashed border-[#000080] bg-blue-50 rounded text-sm font-bold text-[#000080] hover:bg-blue-100 w-full justify-center">
                      <Upload size={18} />
          ...
          <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-5 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 text-sm">Important Notice</h3>
                <p className="text-sm text-gray-700">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-4 bg-[#000080] text-white font-bold rounded flex items-center justify-center gap-2 hover:bg-blue-900"
            >
              Submit Appeal
              <ArrowRight size={18} />
            </button>
