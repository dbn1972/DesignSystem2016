            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-5xl font-bold text-gray-900">Mixed-Language Fallback</h1>
                </div>
              </div>
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-8">
            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg p-6 mb-6">
              <h3 className="font-bold text-gray-900 mb-4">Select Fallback Strategy:</h3>
              <div className="flex gap-3">
                <button
                  onClick={() => setStrategy("inline")}
                  className={`px-6 py-3 rounded font-bold ${
                    strategy === "inline" ? "bg-[#000080] text-white" : "border-2 border-gray-300 text-gray-700"
                  }`}
                >
                  Inline Indicator
                </button>
                <button
                  ...
                  className={`px-6 py-3 rounded font-bold ${
                    strategy === "tooltip" ? "bg-[#000080] text-white" : "border-2 border-gray-300 text-gray-700"
                  }`}
                >
                  Tooltip Hint
                </button>
                <button
                  ...
                  className={`px-6 py-3 rounded font-bold ${
                    strategy === "toggle" ? "bg-[#000080] text-white" : "border-2 border-gray-300 text-gray-700"
                  }`}
                >
                  Show/Hide Toggle
                </button>
            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
              <div className="border-b-2 border-gray-200 pb-4 mb-6">
                <h3 className="text-xl font-bold text-gray-900">आय प्रमाणपत्र आवेदन</h3>
                <p className="text-sm text-gray-600">Income Certificate Application (Target: Hindi)</p>
              </div>
              ...
              {strategy === "inline" && (
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" className="w-full px-4 py-2 border-2 border-gray-300 rounded" placeholder="अपना नाम दर्ज करें" />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="date" className="w-full px-4 py-2 border-2 border-gray-300 rounded" />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea className="w-full px-4 py-2 border-2 border-gray-300 rounded" rows={3} placeholder="अपना पूरा पता दर्ज करें" />
                  </div>
                </div>
              )}
              ...
              {strategy === "tooltip" && (
                <div className="space-y-4">
                  <div>
                    <label className="block font-bold text-gray-900 mb-2">पूरा नाम</label>
                    <input type="text" className="w-full px-4 py-2 border-2 border-gray-300 rounded" placeholder="अपना नाम दर्ज करें" />
                  </div>
                  ...
                  <div className="relative">
                    <label className="block font-bold text-gray-900 mb-2 flex items-center gap-2">
                      Date of Birth
                      <span className="text-xs px-2 py-1 bg-gray-100 text-gray-600 rounded cursor-help" title="Translation not available">
                        ?
                      </span>
                    </label>
                    <input type="date" className="w-full px-4 py-2 border-2 border-gray-300 rounded" />
                  ...
                  <div>
                    <label className="block font-bold text-gray-900 mb-2">पता</label>
                    <textarea className="w-full px-4 py-2 border-2 border-gray-300 rounded" rows={3} placeholder="अपना पूरा पता दर्ज करें" />
                  </div>
                </div>
              )}
                  ...
                  <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-4 mb-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="font-bold text-gray-900 mb-1">Partial Translation</div>
                        <div className="text-sm text-gray-700">
                          Some fields are shown in English as Hindi translation is not yet available.
                          <button className="ml-2 text-[#000080] font-bold hover:underline">
            ...
            <div className="mt-8 space-y-6">
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Fallback Strategies</h2>
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-4">
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">1. Hierarchical Fallback</h3>
                    <p className="text-sm text-gray-700 mb-2">Priority order for missing translations:</p>
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">2. Visual Differentiation</h3>
                    <p className="text-sm text-gray-700">
                      Make fallback content visually distinct with badges, background color, or italics so users know which parts are translated.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">3. Contextual Explanation</h3>
                    <p className="text-sm text-gray-700">
            ...
            <div className="sticky top-8 space-y-6">
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    <div className="text-xs text-gray-600 mb-1">Use Case</div>
                    <div className="font-bold">Incomplete translations</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-600 mb-1">Strategy Types</div>
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <Link to="/patterns/localization/language-switcher" className="block text-sm text-[#000080] hover:underline">
                    → Language Switcher
                  </Link>
                  <Link to="/patterns/localization/translation-confidence" className="block text-sm text-[#000080] hover:underline">
