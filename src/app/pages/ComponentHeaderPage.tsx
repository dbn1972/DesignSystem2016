    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live Header preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {showSearch && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showSearch</span>}
            {showLanguage && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showLanguage</span>}
          </div>
        </div>
      </div>
...
export default function ComponentHeaderPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">He</div>
          <p className="text-sm text-muted-foreground">Header component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          ...
          default: "'government'",
          required: false,
          description: 'Visual variant. Government uses navy blue, light uses white background, dark uses gray-900.',
        },
        {
          name: 'logo',
          type: 'ReactNode',
          required: false,
          description: 'Custom logo element. If not provided, uses default government emblem.',
        },
        {
          name: 'title',
          type: 'string',
          required: false,
          description: 'Portal or application title displayed next to logo.',
        },
        {
          name: 'navLinks',
          type: 'Array<{ label: string; href: string; active?: boolean }>',
          required: false,
          description: 'Navigation links to display in header.',
        },
        {
          name: 'withSearch',
          type: 'boolean',
        ...
        },
        {
          ...
          default: 'false',
          required: false,
          description: 'Show notifications icon with badge.',
        },
        {
          name: 'notificationCount',
          type: 'number',
          required: false,
          description: 'Number of unread notifications to display in badge.',
        },
        {
          name: 'showProfile',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Show user profile dropdown.',
        },
        {
          name: 'userName',
          type: 'string',
          required: false,
          description: 'Logged-in user name to display.',
        },
        {
          name: 'sticky',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether header should stick to top on scroll.',
        },
      ]}
      ...
      additionalContent={
        <>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">Adjust the controls to preview different Header configurations in real time.</p>
            <HeaderPlayground />
          </section>
