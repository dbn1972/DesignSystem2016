...
const ADDRESSAUTOCOMPLETEINDIA_CONTROLS: PlaygroundControl[] = [
  {
    name: 'required',
    label: 'Required',
    type: 'boolean',
...
function AddressAutocompleteIndiaPlayground() {
  return (
    <ComponentPlayground
      ...
      controls={ADDRESSAUTOCOMPLETEINDIA_CONTROLS}
      renderPreview={(v) => (
        <div className="w-full max-w-lg">
          <AddressAutocompleteIndiaPreview {...v} />
        </div>
      )}
      codeTemplate={(v) => {
        const props: string[] = [];
        ADDRESSAUTOCOMPLETEINDIA_CONTROLS.forEach((c) => {
          const val = v[c.name];
        ...
        return `<AddressAutocompleteIndia${props.length ? ' ' + props.join(' ') : ''} />`;
      }}
    />
  );
}
      ...
      props={[
        {
          ...
          type: 'AddressValue',
          required: false,
          description: 'Current address value ({ pincode, state, district, city, address }).',
        },
        {
          name: 'onChange',
        ...
        <>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border-2 border-green-200 dark:border-green-800 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">Auto-fill city and state from PIN code — reduces address errors by 60%.</p>
                </div>
              </div>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <a href="/components/map-location-picker" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
          ...
          <div className="mb-8">
            <AddressAutocompleteIndiaPlayground />
          </div>
