    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live AddressAutocompleteIndia preview with current settings</p>
...
export default function ComponentAddressAutocompleteIndiaPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Ad</div>
          <p className="text-sm text-muted-foreground">AddressAutocompleteIndia component in its default state</p>
        </div>
      }
      ...
      additionalContent={
        <>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">Adjust the controls to preview different AddressAutocompleteIndia configurations in real time.</p>
