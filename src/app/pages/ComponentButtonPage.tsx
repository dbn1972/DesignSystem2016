...
const BUTTON_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'variant', label: 'Variant', type: 'select', defaultValue: 'primary', options: ['primary', 'secondary', 'tertiary', 'destructive', 'ghost', 'success'] },
      ...
      examples={[
        {
          ...
          sandboxHref: '/components/sandbox?preset=button-actions&source=button',
...
export type ButtonType = 'button' | 'submit' | 'reset';`,
      ...
      sandbox={{
        href: '/components/sandbox?preset=button-actions&source=button',
        label: 'Open in Sandbox',
        exampleLabel: 'Edit in Sandbox',
        description: 'Start from the button action preset, then tweak variants, labels, and layout in the live sandbox without leaving the documentation flow.',
      }}
