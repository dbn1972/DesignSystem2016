...
const TOAST_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  ...
  { name: 'description', label: 'Description (optional)', type: 'text', defaultValue: '' },
];
...
function ToastPlayground() {
  return (
    <ComponentPlayground
      ...
      renderPreview={(v) => (
        <ToastPreview variant={v.variant} message={v.message} description={v.description || undefined} />
      )}
      codeTemplate={(v) =>
      ...
      props={[
        {
          ...
          type: 'ReactNode',
          required: true,
          description: 'Primary message content of the toast.',
        },
        {
          name: 'variant',
        ...
        },
        {
          ...
          type: 'ReactNode',
          required: false,
          description: 'Toast title displayed above the message.',
        },
        {
          name: 'closable',
          type: 'boolean',
        ...
        },
        {
          ...
          default: '5000',
          required: false,
          description: 'Auto-close duration in ms. Set to 0 to disable.',
        },
        {
          name: 'onClose',
          type: '() => void',
