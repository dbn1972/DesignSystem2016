import { RefreshCw, CheckCircle, XCircle, AlertCircle, Info, Clock, Users, Shield, Eye, Globe, Code, BarChart3, AlertTriangle, FileText, Lock, Unlock, Edit, Search, ArrowRight, ChevronRight, Check, Database, Zap, Target, Hash, Upload, Download, CreditCard, Award, ChevronDown } from "lucide-react";
            ...
            <div className="p-8 space-y-6">
              <div className="border-2 border-blue-300 bg-blue-50 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  ...
                  <div className="px-4 py-2 bg-green-100 border-2 border-green-300 rounded text-green-800 font-bold text-sm">
                    ACTIVE
                  </div>
                </div>
              </div>
