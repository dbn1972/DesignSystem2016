...
export default function ComponentAvatarPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Av</div>
          <p className="text-sm text-muted-foreground">Avatar component in its default state</p>
        </div>
      }
