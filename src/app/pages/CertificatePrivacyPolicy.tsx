        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-muted-foreground">
                  <span className="font-bold text-foreground">Last Updated:</span> January 1, 2026
                </p>
              ...
              <Section
                ...
                content={
                  <>
                    ...
                    <h4 className="font-bold text-foreground mb-2 text-sm">1.1 Personal Information</h4>
                    ...
                    <h4 className="font-bold text-foreground mb-2 text-sm">1.2 Application-Specific Information</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground mb-4 ml-4">
                    ...
                    <h4 className="font-bold text-foreground mb-2 text-sm">1.3 Technical Information</h4>
              ...
              <Section
                ...
                content={
                  <>
                    ...
                    <h4 className="font-bold text-foreground mb-2 text-sm">3.1 With Government Authorities</h4>
                    ...
                    <h4 className="font-bold text-foreground mb-2 text-sm">3.2 Legal Requirements</h4>
                    <p className="text-sm text-muted-foreground leading-relaxed mb-4 ml-4">
                      We may disclose your information if required by law, court order, or government regulation, 
                      or to protect the rights, property, or safety of our service, users, or the public.
                    </p>

                    <h4 className="font-bold text-foreground mb-2 text-sm">3.3 Service Providers</h4>
                ...
                content={
                  <>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed mt-4">
                      ...
                      <a href="mailto:privacy@certificate.gov.in" className="text-primary font-bold hover:underline">
                ...
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6">
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p className="mt-3">
                      ...
                      <a href="mailto:privacy@certificate.gov.in" className="text-primary hover:underline">
                        privacy@certificate.gov.in
                      </a>
                    </p>
                    <p>
                      <span className="font-bold">Phone:</span>{" "}
                      <a href="tel:1800-111-1111" className="text-primary hover:underline">
                        1800-111-1111
                      </a>
                    </p>
                  </div>
          ...
          <div className="mt-8 text-center">
            <Link
              ...
              className="inline-block px-8 py-3 border-2 border-border bg-card text-muted-foreground font-bold rounded hover:bg-background"
            >
        ...
        <div className="max-w-[1400px] mx-auto px-12 py-8">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-6">
              <Link to="/reference-service/certificate/privacy-policy" className="text-primary font-bold hover:underline">
                Privacy Policy
              </Link>
