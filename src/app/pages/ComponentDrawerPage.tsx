    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live Drawer preview with current settings</p>
      ...
      props={[
        {
          ...
          default: 'false',
          required: true,
          description: 'Controls whether the drawer is visible. Must be managed by parent component state.',
        },
        {
          name: 'onClose',
          type: '() => void',
          required: true,
          description: 'Callback function invoked when drawer should close (overlay click, Escape key, close button).',
        },
        {
          name: 'placement',
          ...
          default: "'right'",
          required: false,
          description: 'Edge from which the drawer slides in. Right for supplementary content, left for navigation, top/bottom for contextual panels.',
        },
        {
          name: 'size',
          type: "'sm' | 'md' | 'lg' | 'full'",
          default: "'md'",
          required: false,
          description: 'Size of the drawer. Small (320px), Medium (384px), Large (600px), Full (100%). Applies to width for left/right, height for top/bottom.',
        },
        {
          name: 'title',
          type: 'string',
          required: false,
          description: 'Title displayed in the drawer header. Automatically creates header with close button.',
        },
        {
          name: 'children',
          type: 'ReactNode',
          required: true,
          description: 'Content to display inside the drawer body. Scrollable if content exceeds viewport.',
        },
        {
          name: 'showOverlay',
          type: 'boolean',
          default: 'true',
          required: false,
          description: 'Whether to show semi-transparent overlay behind drawer. Clicking overlay closes drawer.',
        },
        {
          name: 'header',
          type: 'ReactNode',
          required: false,
          description: 'Custom header content. Overrides default title header. Close button still rendered.',
        },
        {
          name: 'footer',
          type: 'ReactNode',
          required: false,
          description: 'Footer content for actions. Typically contains buttons (Cancel, Apply, Submit).',
        },
        {
        ...
        },
        {
          ...
          default: 'true',
          required: false,
          description: 'Whether pressing Escape key should close the drawer.',
        },
        {
          name: 'className',
          type: 'string',
          required: false,
          description: 'Additional CSS classes to apply to drawer panel.',
        },
      ]}
          ...
          preview: (
            <>
              ...
              >
                <div className="mb-8">
                  <div className="flex justify-between mb-2">
                    <span className={wizardStep >= 1 ? 'text-[#005196] font-medium' : 'text-gray-400'}>
                      Step 1
                    </span>
                    <span className={wizardStep >= 2 ? 'text-[#005196] font-medium' : 'text-gray-400'}>
                      Step 2
                    </span>
                    <span className={wizardStep >= 3 ? 'text-[#005196] font-medium' : 'text-gray-400'}>
                      Step 3
                    </span>
                  </div>
                  <div className="h-2 bg-gray-200 rounded-full">
