...
const DRAWER_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'position', label: 'Position', type: 'text', defaultValue: 'left' },
    ...
    <ComponentPlayground
      ...
      renderPreview={(v) => (
        <div className="relative w-full h-48 rounded-lg overflow-hidden border border-border bg-background">
          ...
          {/* Drawer panel */}
          <div className={`absolute top-0 bottom-0 ${v.position === 'left' ? 'left-0' : 'right-0'} ${v.size === 'sm' ? 'w-1/4' : v.size === 'lg' ? 'w-1/2' : 'w-1/3'} bg-card shadow-xl border border-border flex flex-col`}>
