    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live LanguageSelector preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {showFlag && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showFlag</span>}
          </div>
        </div>
      </div>
    ...
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">LanguageSelector component in its default state</p>
        </div>
      }
