            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-bold text-gray-900">Declaration Before Submission Flow</h1>
                </div>
              </div>
...
function StateIndicator({ currentState }: { currentState: FlowState }) {
  const stateConfig = {
    ...
    "declaration-unchecked": { label: "Unchecked", color: "bg-gray-100 text-gray-700" },
    ...
    <>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="font-bold text-gray-900 mb-1 text-sm">Please Review Carefully</h4>
            <p className="text-sm text-gray-700">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4 flex items-center justify-between">
            ...
            <button className="text-sm text-[#000080] font-bold hover:underline flex items-center gap-1">
              <Edit size={14} />
              Edit
            </button>
          </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-gray-900">Financial Information</h3>
            </div>
            <button className="text-sm text-[#000080] font-bold hover:underline flex items-center gap-1">
              <Edit size={14} />
              Edit
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-gray-900">Documents Uploaded</h3>
            </div>
            <button className="text-sm text-[#000080] font-bold hover:underline flex items-center gap-1">
              <Edit size={14} />
              Edit
        ...
        <div className="flex items-center gap-4 pt-4">
          <button className="px-6 py-4 border-2 border-gray-300 bg-white text-gray-700 font-bold rounded text-sm hover:bg-gray-50">
            Save as Draft
          </button>
          <button
    ...
    <>
      <div className="bg-gray-100 border-b-2 border-gray-300 px-8 py-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Declaration and Submission</h2>
            <p className="text-sm text-gray-700">
              National Scholarship Portal • Post-Matric Scholarship Application
            </p>
          </div>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-5">
          <h3 className="font-bold text-gray-900 mb-3 text-sm">Application Summary</h3>
          <div className="grid grid-cols-3 gap-4 text-sm">
            <div>
              <span className="text-gray-600">Applicant Name:</span>
              <div className="font-bold text-gray-900">{applicationData.applicantName}</div>
            </div>
            <div>
              <span className="text-gray-600">Course:</span>
              <div className="font-bold text-gray-900">{applicationData.courseName}</div>
            </div>
            <div>
              <span className="text-gray-600">Institution:</span>
              <div className="font-bold text-gray-900">{applicationData.institutionName}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
          <div className="flex items-start gap-3 mb-4">
            <Shield size={24} className="text-[#000080] flex-shrink-0" />
            <div>
              <h3 className="font-bold text-gray-900 mb-2">Declaration Statement</h3>
              <p className="text-sm text-gray-700">
          ...
          <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-5 space-y-4">
        ...
        <div className={`border-2 rounded-lg p-6 transition-all ${
          !declarationAccepted && isChecked ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-gray-50'
        }`}>
          <label className="flex items-start gap-4 cursor-pointer">
            ...
            />
            <div className="flex-1">
              <span className="text-sm text-gray-900 font-bold block mb-2" id="declaration-description">
        ...
        <div className="text-center">
          <button
            onClick={onHelp}
            className="text-sm text-[#000080] font-bold hover:underline inline-flex items-center gap-1"
          >
            <HelpCircle size={16} />
        ...
        <div className="flex items-center gap-4 pt-4">
          <button
            onClick={onBack}
            className="px-6 py-4 border-2 border-gray-300 bg-white text-gray-700 font-bold rounded text-sm hover:bg-gray-50"
          >
            Back to Review
          </button>
          <button
  ...
  return (
    <div className="p-12 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-3">Declaration Required</h2>
  ...
  return (
    <div className="p-12">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-3 text-center">Application Submitted Successfully</h2>
        ...
        <div className="bg-green-50 border-2 border-green-300 rounded-lg p-6 mb-8">
          <h3 className="font-bold text-gray-900 mb-4 text-center">Application Details</h3>
          <div className="space-y-3">
            <div className="bg-white border-2 border-green-300 rounded p-4 text-center">
              ...
              <div className="text-lg font-bold text-gray-900 font-mono">{applicationId}</div>
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="bg-white border-2 border-gray-300 rounded p-3">
                <span className="text-gray-600 block mb-1">Applicant Name:</span>
                <div className="font-bold text-gray-900">{applicationData.applicantName}</div>
              </div>
              <div className="bg-white border-2 border-gray-300 rounded p-3">
                <span className="text-gray-600 block mb-1">Submission Date:</span>
                <div className="font-bold text-gray-900">April 9, 2026</div>
              </div>
              <div className="col-span-2 bg-white border-2 border-gray-300 rounded p-3">
...
function NextStep({ step, title, description }: { step: string; title: string; description: string }) {
  return (
    <div className="flex items-start gap-3 pb-3 border-b border-blue-200 last:border-0 last:pb-0">
      <div className="w-7 h-7 bg-[#000080] text-white rounded-full flex items-center justify-center flex-shrink-0 text-xs font-bold">
        {step}
      </div>
      <div className="flex-1">
    ...
    <>
      <div className="bg-orange-100 border-b-2 border-orange-300 px-8 py-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Help with Declaration</h2>
            <p className="text-sm text-gray-700">
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
          <h3 className="font-bold text-gray-900 mb-4">Understanding Each Declaration Point</h3>
        ...
        <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6">
          ...
          <div className="space-y-3 text-sm">
            <div>
              <span className="font-bold text-gray-900 block mb-1">National Scholarship Portal Helpline:</span>
              <div className="text-gray-700">Phone: 0120-6619540 (10 AM - 6 PM, Monday to Friday)</div>
              <div className="text-gray-700">Email: helpdesk@nsp.gov.in</div>
            </div>
            <div>
              <span className="font-bold text-gray-900 block mb-1">State Nodal Officer:</span>
              <div className="text-gray-700">Contact details available in your state's scholarship portal</div>
            </div>
          </div>
        </div>
...
function HelpPoint({ number, title, explanation }: { number: string; title: string; explanation: string }) {
  return (
    <div className="pb-4 border-b border-gray-200 last:border-0 last:pb-0">
      ...
      <p className="text-sm text-gray-700 ml-9">{explanation}</p>
    </div>
  );
}
...
function Concern({ question, answer }: { question: string; answer: string }) {
  return (
    <div>
      <div className="font-bold text-gray-900 mb-1 text-sm">{question}</div>
...
function ApplicationInfo() {
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
      ...
      <div className="space-y-3 text-sm text-gray-700">
        <div>
          <span className="font-bold text-gray-900 block mb-1">Purpose:</span>
          <span>Pre-submission declaration confirming information accuracy</span>
        </div>
        <div>
          <span className="font-bold text-gray-900 block mb-1">Context:</span>
          <span>Scholarship application final submission</span>
        </div>
        <div>
          <span className="font-bold text-gray-900 block mb-1">Required:</span>
...
function StateExplainer({ currentState }: { currentState: FlowState }) {
  ...
  return (
    <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6">
      ...
      <div className="space-y-2">
        <div className="font-bold text-gray-900">{state.title}</div>
