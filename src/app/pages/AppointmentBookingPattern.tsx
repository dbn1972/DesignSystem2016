      ...
      <header className="bg-white border-b-2 border-gray-300">
        <div className="max-w-[1600px] mx-auto px-12 py-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            <Link to="/operational-service-patterns" className="hover:text-[#000080]">
              Operational Service Patterns
            </Link>
            <ChevronRight size={16} />
            <span className="text-gray-900 font-medium">Appointment Booking</span>
          </div>
            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-16 h-16 bg-blue-100 border-2 border-blue-300 rounded flex items-center justify-center">
                  <Calendar size={32} className="text-[#000080]" />
                </div>
                <div>
                  <div className="text-sm text-gray-600 mb-1">UX4G Operational Service Pattern</div>
              ...
              <div className="flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600">Pattern ID: <span className="font-bold text-gray-900">UX4G-PAT-011-01</span></span>
                </div>
                <div className="flex items-center gap-2">
...
function BookingFlow() {
  return (
    <section id="flow" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        <h2 className="text-2xl font-bold text-gray-900">Appointment Booking Flow</h2>
      </div>
        ...
        <div className="mt-8 pt-6 border-t-2 border-gray-200">
          <div className="flex items-center gap-8 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600">System Confirmation</span>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section id="screens" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        ...
        <p className="text-gray-600 mt-2">Representative appointment booking screens</p>
      </div>
  ...
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg p-6 max-w-md mx-auto">
      {type === "calendar" && (
        <>
          <div className="mb-4">
            <h3 className="font-bold text-gray-900 mb-2">Select Date</h3>
            <p className="text-sm text-gray-600">Choose a date for your appointment</p>
          </div>
          ...
          <div className="flex items-center justify-between mb-4 pb-3 border-b-2 border-gray-200">
            ...
            <h4 className="font-bold text-gray-900">April 2026</h4>
            <button className="p-2 hover:bg-gray-100 rounded">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${isAvailable && !isSelected ? 'bg-green-50 text-gray-900 hover:bg-green-100' : ''}
      ...
      {type === "timeslots" && (
        <>
          <div className="mb-4">
            <h3 className="font-bold text-gray-900 mb-1">Select Time Slot</h3>
            <p className="text-sm text-gray-600">Wednesday, April 15, 2026</p>
          </div>

          <div className="space-y-3">
            <div>
              <h4 className="text-sm font-bold text-gray-700 mb-2">Morning</h4>
              <div className="grid grid-cols-2 gap-2">
                <button className="px-4 py-3 border-2 border-gray-300 bg-white rounded text-sm font-medium hover:border-[#000080] hover:bg-blue-50">
                  09:00 AM
                </button>
                <button className="px-4 py-3 border-2 border-gray-300 bg-white rounded text-sm font-medium hover:border-[#000080] hover:bg-blue-50">
                  10:00 AM
                ...
                <button disabled className="px-4 py-3 border-2 border-gray-200 bg-gray-100 rounded text-sm font-medium text-gray-400 cursor-not-allowed">
                  12:00 PM<br/>
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-700 mb-2">Afternoon</h4>
              <div className="grid grid-cols-2 gap-2">
                <button className="px-4 py-3 border-2 border-[#000080] bg-blue-50 rounded text-sm font-medium text-[#000080]">
                  02:00 PM<br/>
          ...
          <button className="w-full mt-6 px-4 py-3 bg-[#000080] text-white font-bold rounded text-sm">
            Continue
          </button>
        </>
      )}
      ...
      {type === "confirmed" && (
        <div className="text-center py-6">
          ...
          <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 mb-6 text-left">
            <h5 className="font-bold text-gray-900 text-sm mb-3">Appointment Details</h5>
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-2">
                <Calendar size={16} className="text-blue-600 mt-0.5" />
                <div>
                  <div className="font-bold text-gray-900">Wednesday, April 15, 2026</div>
                  <div className="text-gray-600">02:00 PM - 03:00 PM</div>
                </div>
              </div>
              <div className="flex items-start gap-2">
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              <div className="text-xs font-bold text-gray-700 mb-1">Booking Reference</div>
              <div className="font-mono text-sm font-bold text-gray-900">APT-2026-04-15-0234</div>
            </div>
          </div>
        ...
        <>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-green-50 border-2 border-green-300 rounded-lg p-4">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <div className="font-bold text-gray-900">Document Verification</div>
                </div>
              ...
              <div className="flex gap-2">
                <button className="flex-1 px-3 py-2 border-2 border-gray-300 bg-white text-gray-700 font-bold rounded text-xs">
                  Reschedule
                </button>
                <button className="flex-1 px-3 py-2 border-2 border-red-300 bg-white text-red-700 font-bold rounded text-xs">
                  Cancel
                </button>
              </div>
            </div>
            ...
            <div className="bg-gray-100 border-2 border-gray-300 rounded-lg p-4">
              <div className="flex items-start justify-between mb-3">
                <div>
                  <div className="text-xs font-bold text-gray-600 mb-1">COMPLETED</div>
                  <div className="font-bold text-gray-700">License Renewal</div>
                </div>
...
function SlotManagement() {
  return (
    <section id="slots" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        <h2 className="text-2xl font-bold text-gray-900">Slot Management Guidelines</h2>
        <p className="text-gray-600 mt-2">Best practices for managing appointment slots</p>
      </div>

      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Slot Configuration</h3>
          </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Availability Display</h3>
          </div>
          <div className="p-6 space-y-3 text-sm">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden col-span-2">
          <div className="bg-blue-50 border-b-2 border-blue-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Booking Rules</h3>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3 text-sm">
...
function ConfirmationSection() {
  return (
    <section id="confirmation" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        <h2 className="text-2xl font-bold text-gray-900">Confirmation & Reminders</h2>
        <p className="text-gray-600 mt-2">What to send and when</p>
      </div>

      <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
        <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
          <h3 className="font-bold text-gray-900">Confirmation Elements</h3>
        </div>
        <div className="p-6">
          <div className="space-y-4">
            <ConfirmationItem
      ...
      <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-2 gap-6 text-sm">
            <div>
              <h4 className="font-bold text-gray-900 mb-3">Must Include:</h4>
              <div className="space-y-2">
            ...
            <div>
              <h4 className="font-bold text-gray-900 mb-3">Should Include:</h4>
              <div className="space-y-2">
...
function ConfirmationItem({ title, timing, channels, content }: {
  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded p-4">
      ...
      <div className="mb-2">
        <span className="text-xs font-bold text-gray-600">Channels: </span>
        <span className="text-sm text-gray-700">{channels.join(", ")}</span>
      </div>
...
function RescheduleCancel() {
  return (
    <section id="rescheduling" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        <h2 className="text-2xl font-bold text-gray-900">Reschedule & Cancellation</h2>
        <p className="text-gray-600 mt-2">Self-service appointment management</p>
      </div>

      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-orange-50 border-b-2 border-orange-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Reschedule Flow</h3>
          </div>
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-red-50 border-b-2 border-red-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Cancellation Flow</h3>
          </div>
          <div className="p-6 space-y-3">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden col-span-2">
          <div className="bg-blue-50 border-b-2 border-blue-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Business Rules</h3>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div>
                <h4 className="font-bold text-gray-900 mb-3">Rescheduling:</h4>
                <div className="space-y-2">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-3">Cancellation:</h4>
                <div className="space-y-2">
...
function RescheduleStep({ step, text }: { step: string; text: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-6 h-6 rounded-full bg-[#000080] text-white flex items-center justify-center font-bold text-xs flex-shrink-0">
        {step}
      </div>
      <span className="text-sm text-gray-700">{text}</span>
    </div>
  ...
  return (
    <section id="accessibility" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        ...
        <p className="text-gray-600 mt-2">WCAG 2.1 AA compliance for appointment booking</p>
      </div>

      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Calendar Accessibility</h3>
          </div>
          <div className="p-6 space-y-3 text-sm">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Time Slot Selection</h3>
          </div>
          <div className="p-6 space-y-3 text-sm">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden col-span-2">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">General Requirements</h3>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-3 text-sm">
  ...
  return (
    <section id="implementation" className="space-y-6 scroll-mt-24">
      <div className="border-l-4 border-[#000080] pl-4">
        ...
        <p className="text-gray-600 mt-2">Technical guidance for developers</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden col-span-2">
          <div className="bg-blue-50 border-b-2 border-blue-300 px-6 py-4">
            <h3 className="font-bold text-gray-900">Key Considerations</h3>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div>
                <h4 className="font-bold text-gray-900 mb-3">Concurrency Handling:</h4>
                <div className="space-y-2">
    ...
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="p-4 space-y-3 text-sm">
        <div>
          ...
          <div className="text-gray-700">Operational Service</div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-3">
          ...
          <div className="text-gray-700">3-4 days</div>
        </div>
        <div className="border-t border-gray-200 pt-3">
          <div className="font-bold text-gray-900 mb-1">Dependencies</div>
          <div className="text-gray-700">Calendar integration, SMS/Email service</div>
        </div>
      </div>
    </div>
  );
...
function UseCases() {
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
      <div className="bg-gray-100 border-b-2 border-gray-300 px-4 py-3">
        <h3 className="font-bold text-sm text-gray-900">Common Use Cases</h3>
      </div>
...
function UseCaseItem({ text }: { text: string }) {
  return (
    <div className="flex items-start gap-2 text-gray-700">
      <Calendar size={14} className="text-[#000080] mt-0.5 flex-shrink-0" />
      <span>{text}</span>
    </div>
  );
}
    ...
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="p-4 space-y-2">
        ...
        >
          ...
          <div className="text-xs text-gray-600">For paid appointments</div>
        </Link>
        <Link 
        ...
        >
          ...
          <div className="text-xs text-gray-600">Appointment reminders</div>
        </Link>
        <Link 
        ...
        >
          ...
          <div className="text-xs text-gray-600">Incomplete booking recovery</div>
        </Link>
      </div>
    </div>
  );
