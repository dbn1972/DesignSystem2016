    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live VideoPlayer preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {showCaptions && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showCaptions</span>}
            {autoPlay && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">autoPlay</span>}
          </div>
        </div>
      </div>
...
export default function ComponentVideoPlayerPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Vi</div>
          <p className="text-sm text-muted-foreground">VideoPlayer component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          name: 'src',
          type: 'string | { quality: string; url: string }[]',
          required: true,
          description: 'Video source URL or array of quality options with URLs.',
        },
        {
          name: 'poster',
          type: 'string',
          required: false,
          description: 'URL of poster image displayed before video plays.',
        },
        {
          name: 'autoPlay',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether video should autoplay. Use cautiously for accessibility.',
        },
        {
          name: 'loop',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether video should loop continuously.',
        },
        {
          name: 'muted',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether video is muted by default. Required for autoplay in most browsers.',
        },
        {
          name: 'controls',
          type: 'boolean',
          default: 'true',
          required: false,
          description: 'Whether to show video controls (play, pause, volume, etc.).',
        },
        {
          name: 'subtitles',
          type: '{ lang: string; label: string; src: string; default?: boolean }[]',
          required: false,
          description: 'Array of subtitle/caption tracks in different languages.',
        },
        {
          name: 'quality',
          type: "'auto' | '240p' | '360p' | '480p' | '720p' | '1080p'",
          default: "'auto'",
          required: false,
          description: 'Video quality setting. Auto adapts based on connection.',
        },
        {
          name: 'playbackRate',
          type: 'number',
          default: '1.0',
          required: false,
          description: 'Playback speed (0.5x to 2.0x). Useful for tutorials and educational content.',
        },
        {
          name: 'onPlay',
          type: '(event: Event) => void',
          required: false,
          description: 'Callback fired when video starts playing.',
        },
        {
          name: 'onPause',
          type: '(event: Event) => void',
          required: false,
          description: 'Callback fired when video is paused.',
        },
        {
          name: 'onEnded',
          type: '(event: Event) => void',
        ...
        },
        {
          ...
          default: 'false',
          required: false,
          description: 'Whether to show download button for offline access.',
        },
        {
          name: 'captions',
          type: 'boolean',
          default: 'true',
          required: false,
          description: 'Whether to enable closed captions. Required for WCAG compliance.',
        },
      ]}
