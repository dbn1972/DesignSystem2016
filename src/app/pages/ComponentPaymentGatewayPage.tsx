...
const PAYMENTGATEWAY_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'showUPI', label: 'Show U P I', type: 'boolean', defaultValue: false },
  { name: 'showCard', label: 'Show Card', type: 'boolean', defaultValue: false },
  { name: 'showNetBanking', label: 'Show Net Banking', type: 'boolean', defaultValue: false },
];
