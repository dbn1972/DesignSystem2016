        ...
        <div className="max-w-[1200px] mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-gray-900">Global Search</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1200px] mx-auto px-8 py-12">
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-3">Find Government Services</h1>
          ...
          <div className="relative mb-12">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:border-[#000080] shadow-sm"
            ...
            {showSuggestions && suggestions.length > 0 && (
              <div
                ...
                role="listbox"
                className="absolute top-full left-0 right-0 mt-2 bg-white border-2 border-gray-300 rounded-lg shadow-lg z-10"
              >
                <div className="p-2">
                  <div className="text-xs font-bold text-gray-600 px-3 py-2">
                  ...
                  {suggestions.map((service, index) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-3 rounded transition-colors ${
                        focusedIndex === index
                          ? 'bg-blue-50 border-l-4 border-[#000080]'
                          : 'hover:bg-gray-50'
                      }`}
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-gray-600">{service.department}</div>
                        </div>
            ...
            {showSuggestions && suggestions.length === 0 && !isLoading && query.length >= 2 && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white border-2 border-gray-300 rounded-lg shadow-lg z-10 p-6 text-center">
                <div className="text-gray-600 mb-4">No services found for "{query}"</div>
                <Link
                  to="/patterns/search-discovery/guided-finder"
                  className="inline-flex items-center gap-2 text-[#000080] hover:underline"
                >
          ...
          {!query && (
            <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {POPULAR_SEARCHES.map((search, i) => (
                    <button
                      ...
                      className="px-4 py-2 bg-white border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:bg-blue-50 transition-colors"
                    >
                      {search}
                    </button>
                  ))}
                  ...
                  <div className="flex flex-wrap gap-3">
                    {RECENT_SEARCHES.map((search, i) => (
                      <button
                        key={i}
                        onClick={() => setQuery(search)}
                        className="px-4 py-2 bg-white border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:bg-blue-50 transition-colors flex items-center gap-2"
                      >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['Civil Registration', 'Transport', 'Identity', 'Revenue', 'Election', 'Food & Supplies'].map((category, i) => (
                    <Link
                      ...
                      className="p-4 bg-white border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:shadow-md transition-all group"
                    >
              ...
              <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6">
                <h3 className="font-bold text-gray-900 mb-3">Need help finding a service?</h3>
          ...
          <div className="mt-12 bg-purple-50 border-2 border-purple-200 rounded-lg p-6">
            <h3 className="font-bold text-gray-900 mb-3">Pattern Behavior</h3>
            <div className="grid grid-cols-3 gap-6 text-sm">
              <div>
                <div className="text-gray-600 mb-1">Autocomplete Trigger</div>
                <div className="font-bold text-gray-900">2 characters</div>
              </div>
              <div>
                <div className="text-gray-600 mb-1">Max Suggestions</div>
                <div className="font-bold text-gray-900">5 results</div>
              </div>
              <div>
                <div className="text-gray-600 mb-1">Keyboard Support</div>
                <div className="font-bold text-gray-900">Arrow keys, Enter, Esc</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 bg-white border-2 border-gray-300 rounded-lg p-6">
            <h3 className="font-bold text-gray-900 mb-3">States Demonstrated</h3>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <div className="font-bold text-gray-700 mb-2">✅ Implemented</div>
