...
const BACKTOTOP_CONTROLS: PlaygroundControl[] = [
  {
    name: 'smooth',
    label: 'Smooth',
    type: 'boolean',
  ...
  return (
    <ComponentPlayground
      ...
      codeTemplate={(v) => {
        ...
        return `<BackToTop${props.length ? ' ' + props.join(' ') : ''} />`;
      }}
    />
  );
}
      ...
      props={[
        {
          ...
          type: 'number',
          required: false,
          description: 'Scroll threshold in pixels before the button appears.',
        },
        {
          name: 'label',
          type: 'string',
