...
export default function ComponentPANCardInputPage() {
  ...
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">PA</div>
          <p className="text-sm text-muted-foreground">PANCardInput component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          ...
          type: 'string',
          required: true,
          description: 'The current PAN card number value. Must follow format: 5 letters, 4 digits, 1 letter (e.g., ABCDE1234F).',
        },
        {
          name: 'onChange',
          type: '(value: string) => void',
          required: true,
          description: 'Callback fired when the PAN value changes. Receives sanitized uppercase value.',
        },
        {
          name: 'onValidate',
          type: '(isValid: boolean, error?: string) => void',
          required: false,
          description: 'Callback fired when validation state changes. Receives validation status and error message.',
        },
        {
          name: 'format',
          type: "'uppercase' | 'mixed'",
          default: "'uppercase'",
          required: false,
          description: 'Text formatting. PAN cards are typically uppercase only.',
        },
        {
          name: 'mask',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether to mask middle 4 digits for privacy (ABCDE****F). Used for display after entry.',
        },
        {
          name: 'required',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether the field is required. Adds asterisk to label and enforces validation.',
        },
        {
          name: 'error',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether the field has a validation error. Changes border color to red.',
        },
        {
          name: 'helperText',
          type: 'string',
          required: false,
          description: 'Helper or error text displayed below the input field.',
        },
        {
          name: 'verifyWithITD',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Enable real-time verification with Income Tax Department API. Requires API credentials.',
        },
        {
          name: 'disabled',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether the input is disabled. Prevents interaction and applies disabled styling.',
        },
        {
          name: 'placeholder',
          type: 'string',
          default: "'AAAAA9999A'",
          required: false,
          description: 'Placeholder text showing the expected format.',
        },
        {
          name: 'autoComplete',
          type: 'string',
          default: "'off'",
          required: false,
          description: 'HTML autocomplete attribute. Use "off" for sensitive data.',
        },
        {
          name: 'name',
          type: 'string',
