...
export default function NotificationOverview() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-br from-purple-50 via-white to-pink-50 border-b-2 border-gray-300">
        <div className="max-w-[1400px] mx-auto px-12 py-12">
          ...
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 border-2 border-gray-300 rounded flex items-center justify-center">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
                    <h3 className="font-bold text-gray-900 mb-3">Without Smart Notifications</h3>
                  ...
                  <div className="bg-green-50 border-2 border-green-200 rounded-lg p-6">
                    <h3 className="font-bold text-gray-900 mb-3">With Smart Notifications</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
                <table className="w-full">
                  <thead className="bg-gray-100 border-b-2 border-gray-300">
                    <tr>
                      <th className="text-left p-4 font-bold text-gray-900">Scenario</th>
                      <th className="text-center p-4 font-bold text-gray-900">SMS</th>
                      <th className="text-center p-4 font-bold text-gray-900">Email</th>
                      <th className="text-center p-4 font-bold text-gray-900">In-App</th>
                      <th className="text-center p-4 font-bold text-gray-900">Push</th>
                    </tr>
                  </thead>
            ...
            <section>
              ...
              <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-8">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-bold text-gray-900 mb-3">Default Limits</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-3">Smart Batching</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <section>
              ...
              <div className="bg-red-50 border-2 border-red-300 rounded-lg p-8">
                <div className="flex items-start gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">Critical Compliance Requirements</h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-bold text-gray-900 mb-3">Data Protection</h4>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-600 mt-0.5 flex-shrink-0" />
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-3">User Rights</h4>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-600 mt-0.5 flex-shrink-0" />
...
function MatrixRow({ scenario, sms, email, inapp, push }: {
  ...
  return (
    <tr>
      <td className="p-4 text-sm text-gray-900">{scenario}</td>
  ...
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden sticky top-24">
      ...
      <div className="p-4 space-y-2 text-sm">
        ...
        <a href="#channel-matrix" className="block text-gray-700 hover:text-[#000080]">Channel Matrix</a>
        <a href="#frequency" className="block text-gray-700 hover:text-[#000080]">Frequency</a>
        <a href="#privacy" className="block text-gray-700 hover:text-[#000080]">Privacy</a>
      </div>
    </div>
  );
}
...
function Resources() {
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="p-4 space-y-2 text-sm">
        <Link to="/patterns/notifications" className="flex items-center gap-2 text-gray-700 hover:text-[#000080]">
          <ArrowRight size={14} />
