          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <h1 className="text-5xl font-bold text-gray-900">Auto-fill from Aadhaar / DigiLocker</h1>
              </div>
            </div>
          ...
          <div className="col-span-8">
            ...
            {!method && (
              <div className="space-y-4">
                <h3 className="font-bold text-gray-900 mb-4">Choose Auto-fill Method</h3>

                <button
                  onClick={() => setMethod("aadhaar")}
                  className="w-full bg-white border-2 border-gray-300 rounded-lg p-6 hover:border-[#000080] hover:bg-blue-50 transition-all text-left"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-gray-900 mb-2">Aadhaar eKYC</div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-gray-900 mb-2">DigiLocker</div>
                      <div className="text-sm text-gray-700 mb-3">
            ...
            {method === "aadhaar" && !verified && (
              <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="font-bold text-gray-900">Aadhaar eKYC Verification</h3>
                  <button
                    onClick={() => {
                      setMethod(null);
                      setOtpSent(false);
                    ...
                    className="text-sm text-gray-600 hover:text-[#000080]"
                  >
                    Change Method
                  </button>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block font-bold text-gray-900 mb-2">Aadhaar Number</label>
                    <input
                      type="text"
                      value={aadhaarNumber}
                  ...
                  {!otpSent ? (
                    <button
                      ...
                      className="w-full px-6 py-3 bg-[#000080] text-white rounded font-bold hover:bg-blue-900 disabled:bg-gray-300 disabled:cursor-not-allowed"
                    >
                      Send OTP
                    </button>
                  ) : (
                    <>
                      ...
                      <div>
                        <label className="block font-bold text-gray-900 mb-2">Enter OTP</label>
                        <input
                          type="text"
                          value={otp}
                          ...
                          maxLength={6}
                        />
                        <div className="text-xs text-gray-600 mt-1">Demo: Use any 6-digit number</div>
                      </div>
            ...
            {method === "digilocker" && !verified && (
              <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="font-bold text-gray-900">DigiLocker Authorization</h3>
                  <button
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mb-6">
                  <div className="font-bold text-gray-900 mb-3">DigiLocker will provide:</div>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-[#000080] text-white rounded font-bold hover:bg-blue-900 flex items-center justify-center gap-2"
                >
                  <Lock size={18} />
            ...
            {verified && formData && (
              <div className="space-y-6">
                <div className="bg-green-50 border-2 border-green-200 rounded-lg p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">Verification Successful</div>
                    <div className="text-sm text-gray-700">
                ...
                <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
                  <h3 className="font-bold text-gray-900 mb-6">Auto-filled Personal Details</h3>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        <label className="block font-bold text-gray-900 mb-2">Date of Birth</label>
                        <input
                          type="text"
                          value={formData.dob}
                          className="w-full px-4 py-3 border-2 border-green-500 bg-green-50 rounded"
                      ...
                      {formData.pan && (
                        <div>
                          <label className="block font-bold text-gray-900 mb-2">PAN Number</label>
                          <input
                            type="text"
                            value={formData.pan}
                            className="w-full px-4 py-3 border-2 border-green-500 bg-green-50 rounded"
                    ...
                    {formData.education && (
                      <div>
                        <label className="block font-bold text-gray-900 mb-2">Education</label>
                        <input
                          type="text"
                    ...
                    {formData.documents && (
                      <div>
                        <label className="block font-bold text-gray-900 mb-2">Documents from DigiLocker</label>
                        <div className="space-y-2">
                          {formData.documents.map((doc: string, idx: number) => (
                            <div key={idx} className="flex items-center gap-2 text-sm text-gray-700 bg-blue-50 border border-blue-200 rounded px-3 py-2">
            ...
            <div className="mt-8 space-y-6">
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Integration Requirements</h2>
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                  <div className="space-y-4 text-sm">
                    <div>
                      <h3 className="font-bold text-gray-900 mb-2">Aadhaar eKYC</h3>
              ...
              <section>
                ...
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-3 text-sm">
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">1. No Storage of Aadhaar Number</h3>
                    <p className="text-gray-700">
                      Never store Aadhaar numbers. Store only masked number and transaction ID for audit trail.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">2. Encrypted Data Transmission</h3>
                    <p className="text-gray-700">
                      Use 2048-bit RSA encryption for all Aadhaar API calls. DigiLocker uses OAuth 2.0 over HTTPS.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">3. Clear Consent Flow</h3>
                    <p className="text-gray-700">
                      Explicitly show what data will be accessed and require user consent before authentication.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">4. Allow Manual Override</h3>
                    <p className="text-gray-700">
          ...
          <aside className="col-span-4">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6">
                <h3 className="font-bold text-gray-900 mb-3">Compliance Required</h3>
                <ul className="space-y-2 text-xs text-gray-700">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/patterns/identity" className="block text-sm text-[#000080] hover:underline">
                    → Identity Patterns
                  </Link>
                  <Link to="/patterns/consent" className="block text-sm text-[#000080] hover:underline">
                    → Consent Patterns
                  </Link>
                </div>
              </div>
