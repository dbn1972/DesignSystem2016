...
export default function GSTRegSubmission() {
  const referenceNumber = "CBIC-2026-GST-" + String(Math.floor(100000 + Math.random() * 900000));
    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b-2 border-border">
        <div className="max-w-[1000px] mx-auto px-6 py-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-foreground">GST Registration Application Submitted</h1>
          <p className="text-sm text-muted-foreground mt-2">Your GST registration application is now under review by the GST Officer.</p>
        </div>
      </header>
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-8 space-y-5">
        <section className="bg-card border-2 border-border rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-5 text-sm">
            ...
            <Detail label="Registration Type" value="Regular Taxpayer" />
            <Detail label="Submission Date" value={submittedDate} />
            <Detail label="Current Status" value="Submitted — GSTIN Pending" />
          </div>
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-3">
            ...
            <Link to="/services/gst-registration/status-tracker" className="inline-flex items-center justify-center px-4 py-2 border-2 border-primary text-primary rounded font-bold text-sm hover:bg-blue-50 dark:bg-blue-900/20">
              Track Status
            </Link>
          </div>
        </section>
        ...
        <section className="bg-blue-50 dark:bg-blue-950/30 border-2 border-blue-300 rounded-lg p-5">
          ...
          <ol className="list-decimal list-inside text-sm text-muted-foreground mt-3 space-y-1">
            <li>Your business details and documents will be verified by the GST Officer.</li>
            <li>You may receive a request for clarification or additional documents.</li>
            <li>Upon approval, your GSTIN will be generated within 7-10 working days.</li>
            <li>GST Registration Certificate will be available for download.</li>
          </ol>
        </section>
      </div>
    </div>
