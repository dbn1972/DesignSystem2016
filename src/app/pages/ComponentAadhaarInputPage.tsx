    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live AadhaarInput preview with current settings</p>
      ...
      <div className="space-y-4 text-sm">
        ...
        <div className="p-3 rounded-lg bg-muted/50 border border-border">
          <p className="font-mono text-xs text-muted-foreground break-all">
            {`<AadhaarInput${required ? ' required' : ''}${disabled ? ' disabled' : ''} />`}
          </p>
        </div>
      </div>
    </div>
...
export default function ComponentAadhaarInputPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Aa</div>
          <p className="text-sm text-muted-foreground">AadhaarInput component in its default state</p>
        </div>
      }
      ...
      additionalContent={
        <>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border-2 border-green-200 rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <p className="text-sm text-muted-foreground">Group digits in 4-4-4 format — it reduces entry errors by 35%.</p>
                </div>
              </div>
              <div className="border-2 border-red-200 rounded-lg overflow-hidden">
                <div className="bg-red-50 px-4 py-2 text-sm font-bold text-red-800">✗ Don&apos;t</div>
                <div className="p-4">
                  <p className="text-sm text-muted-foreground">Don&apos;t accept Aadhaar as a single text field without masking — it is error-prone.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">Adjust the controls to preview different AadhaarInput configurations in real time.</p>
