  ...
  return (
    <div className="relative w-full max-w-md" ref={wrapperRef}>
      <div className={'relative flex flex-col gap-2 ' + (multiple ? 'min-h-[44px]' : '')}>
        <div className={'flex items-center gap-2 rounded border border-gray-300 bg-white ' + (disabled ? 'opacity-60 cursor-not-allowed bg-gray-50' : 'cursor-text')}>
                  ...
                  {group.items.map((option: any, optionIndex: number) => {
                    ...
                    return (
                      <div
                        ...
                        className={'px-3 py-2 cursor-pointer flex items-center justify-between ' + (isHighlighted ? 'bg-blue-50' : isSelected ? 'bg-blue-100' : 'hover:bg-gray-50')}
  ...
  return (
    <div className="relative w-full max-w-md" ref={wrapperRef}>
      <div className="relative">
        <div className="flex items-center gap-2 rounded border border-gray-300 bg-white">
