...
export default function GSTRegFeedback() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (rating > 0) {
      navigate("/services/gst-registration/my-applications");
    }
  };
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-12">
        <div className="max-w-2xl mx-auto">
          <div className="bg-green-50 dark:bg-green-950/30 border-2 border-green-300 rounded-lg p-6 mb-8 text-center">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Congratulations on Your GST Registration!</h2>
            <p className="text-sm text-muted-foreground">Your GSTIN has been generated and Registration Certificate issued. We would love to hear about your experience.</p>
          </div>
            ...
            <div className="p-8 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {["Registration Process", "Website Usability", "Processing Time", "GST Officer Support", "Document Requirements", "Overall Service"].map((cat) => (
              ...
              <div className="text-center">
                <Link to="/services/gst-registration/my-applications" className="text-sm text-muted-foreground hover:text-foreground">Skip for now</Link>
              </div>
            </div>
          </form>
        </div>
