          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border-2 border-green-200 dark:border-green-800 rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <div className="space-y-3 mb-3"><div className="flex gap-3"><div className="w-3 h-3 rounded-full bg-green-50 dark:bg-green-900/200 mt-0.5 shrink-0" /><div><p className="text-xs font-medium text-foreground">Application Submitted</p><p className="text-[10px] text-muted-foreground">12 Apr 2026</p></div></div><div className="flex gap-3"><div className="w-3 h-3 rounded-full bg-yellow-500 mt-0.5 shrink-0" /><div><p className="text-xs font-medium text-foreground">Under Review</p><p className="text-[10px] text-muted-foreground">14 Apr 2026</p></div></div></div>
