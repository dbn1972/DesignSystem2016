    ...
    {items.map((item: any, index: number) => (
      ...
      >
        ...
        <div className="flex-1 pb-8">
          ...
          {item.metadata && (
            <div className="text-xs text-gray-500 mt-2">{item.metadata}</div>
          )}
        </div>
      </div>
    ))}
...
export default function ComponentTimelinePage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">Ti</div>
          <p className="text-sm text-muted-foreground">Timeline component in its default state</p>
        </div>
      }
      ...
      props={[
        {
          ...
          type: 'TimelineItem[]',
          required: true,
          description: 'Array of timeline items to display. Each item contains title, description, date, status, and optional metadata.',
        },
        {
          name: 'variant',
          type: "'default' | 'alternate' | 'left-aligned'",
          default: "'default'",
          required: false,
          description: 'Layout variant. Default shows dates on left, alternate alternates left/right, left-aligned stacks date above content.',
        },
        {
          name: 'orientation',
          ...
          default: "'vertical'",
          required: false,
          description: 'Timeline orientation. Currently only vertical is supported.',
        },
        {
          name: 'showConnector',
          type: 'boolean',
          default: 'true',
          required: false,
          description: 'Whether to show connecting line between timeline items.',
        },
        {
          name: 'iconPosition',
          ...
          default: "'center'",
          required: false,
          description: 'Vertical position of the icon within timeline item.',
        },
        {
          name: 'colored',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether to use colored icons and connectors based on status.',
        },
        {
          name: 'className',
          type: 'string',
          required: false,
          description: 'Additional CSS classes to apply. Merged with base timeline classes.',
        },
      ]}
