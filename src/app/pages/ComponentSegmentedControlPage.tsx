    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live SegmentedControl preview with current settings</p>
  ...
  return (
    <ComponentDocumentation
      ...
      props={[
        {
          name: 'options',
          type: 'Array<{value: string; label: string; icon?: ReactNode}>',
          required: true,
          description: 'Array of options to display. Each option must have a value and label. Icons are optional.',
        },
        {
          name: 'value',
          type: 'string',
          required: true,
          description: 'Currently selected value. Should match one of the option values.',
        },
        {
          name: 'onChange',
          type: '(value: string) => void',
          required: true,
          description: 'Callback fired when selection changes. Receives the new value.',
        },
        {
          name: 'size',
          type: "'sm' | 'md' | 'lg'",
          default: "'md'",
          required: false,
          description: 'Size of the segmented control. Small (28px), Medium (36px), Large (44px).',
        },
        {
          name: 'variant',
          ...
          default: "'default'",
          required: false,
          description: 'Visual variant. Default uses neutral gray, primary uses brand colors.',
        },
        {
          name: 'fullWidth',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether the control should take full width with evenly distributed options.',
        },
        {
          name: 'orientation',
          ...
          default: "'horizontal'",
          required: false,
          description: 'Layout orientation. Horizontal for inline, vertical for stacked options.',
        },
        {
          name: 'disabled',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Whether the control is disabled. Prevents interaction and applies disabled styling.',
        },
        {
          name: 'iconOnly',
          type: 'boolean',
          default: 'false',
          required: false,
          description: 'Display only icons without labels. Requires all options to have icons.',
        },
        {
          name: 'className',
          type: 'string',
        ...
        },
        {
          ...
          type: 'string',
          required: false,
          description: 'Accessible label for the radiogroup. Required when no visible label exists.',
        },
      ]}
