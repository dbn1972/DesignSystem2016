          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <h1 className="text-5xl font-bold text-gray-900">Translation Confidence Indicators</h1>
              </div>
            </div>
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
                <div className="bg-green-50 border-b-2 border-green-200 px-6 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-gray-900">Verified Translation</span>
                  </div>
                ...
                <div className="p-6">
                  <h3 className="font-bold text-gray-900 mb-2">आय प्रमाणपत्र के लिए आवेदन करें</h3>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <span className="text-gray-600">Professionally translated • Reviewed by 2 experts</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
                <div className="bg-yellow-50 border-b-2 border-yellow-200 px-6 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-gray-900">Machine Translation</span>
                  </div>
                ...
                <div className="p-6">
                  ...
                  {showOriginal && (
                    <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-4 mb-4">
                      <div className="text-xs text-gray-600 mb-2 font-bold">ORIGINAL (English)</div>
                      <p className="text-sm text-gray-700">
                  ...
                  <div className="flex items-center gap-3">
                    <button className="text-sm px-4 py-2 border-2 border-gray-300 rounded font-bold hover:bg-gray-50">
                      Report Issue
                    </button>
                    <button className="text-sm px-4 py-2 bg-[#000080] text-white rounded font-bold hover:bg-blue-900">
              ...
              <div className="bg-white border-2 border-red-300 rounded-lg overflow-hidden">
                <div className="bg-red-50 border-b-2 border-red-200 px-6 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-gray-900">Low Quality Translation</span>
                  </div>
                ...
                <div className="p-6">
                  <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4 mb-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-bold text-gray-900 mb-1">Translation Quality Warning</div>
                        <div className="text-sm text-gray-700 mb-2">
            ...
            <div className="mt-8 space-y-6">
                ...
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-1">High Confidence (Verified)</h3>
                        <p className="text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-1">Medium Confidence (Machine)</h3>
                        <p className="text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 mb-1">Low Confidence (Warning)</h3>
                        <p className="text-sm text-gray-700">
              ...
              <section>
                ...
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-3 text-sm">
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">1. Always Show Translation Source</h3>
                    <p className="text-gray-700">
                      Indicate whether content is professionally translated, machine translated, or user-contributed.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">2. Provide Original Access</h3>
                    <p className="text-gray-700">
                      For medium/low confidence, always allow users to view original language version.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">3. Enable Feedback</h3>
                    <p className="text-gray-700">
                      Allow users to report translation errors or suggest improvements for crowdsourced quality.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 mb-1">4. Context-Appropriate Warnings</h3>
                    <p className="text-gray-700">
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <Link to="/patterns/feedback" className="block text-sm text-[#000080] hover:underline">
                    → Feedback Patterns
                  </Link>
                </div>
              </div>
