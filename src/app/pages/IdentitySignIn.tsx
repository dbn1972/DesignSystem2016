            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="bg-white border-b-2 border-gray-300 px-8 py-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm text-gray-600">
                    New user? <Link to="/patterns/identity/sign-up" className="text-[#000080] font-bold hover:underline">Create Account</Link>
                  </div>
                </div>
              </div>
                ...
                <div className="max-w-xl mx-auto">
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 mt-2">Use your registered mobile number (10 digits) or email address</div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Link to="/patterns/identity/forgot-password" className="text-sm text-[#000080] font-bold hover:underline">
                          Forgot Password?
                        </Link>
                      </div>
                      <div className="relative">
                    ...
                    <div className="pt-4">
                      <button
                        type="submit"
                        className="w-full px-8 py-5 bg-[#000080] text-white font-bold rounded-lg hover:bg-[#000060] text-lg transition-colors"
                      >
                        Sign In
                      </button>
                    </div>
                  ...
                  <div className="mt-8">
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                      <Link
                        ...
                        className="flex items-center justify-center gap-3 px-6 py-4 border-2 border-gray-300 rounded-lg hover:border-[#000080] hover:bg-blue-50 transition-colors"
                      >
                        <Smartphone size={20} className="text-[#000080]" />
                        <span className="font-bold text-gray-900">Mobile OTP</span>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <span className="font-bold text-gray-900">Aadhaar</span>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-bold text-sm text-gray-900 mb-1">Secure Connection</div>
                  ...
                  <div className="mt-6 text-center text-sm text-gray-600">
                    Can't access your account? <Link to="/patterns/identity/account-recovery" className="text-[#000080] font-bold hover:underline">Account Recovery</Link>
                  </div>
                </div>
              </div>
            </div>
  ...
  return (
    <div className="border-2 border-gray-300 rounded-lg overflow-hidden bg-white">
      <div className="bg-gray-100 border-b-2 border-gray-300 px-4 py-3">
        <h3 className="font-bold text-gray-900 text-sm">Sign In Options</h3>
      </div>
      <div className="p-4">
...
function FlowOption({ label, active = false, href }: { label: string; active?: boolean; href?: string }) {
  const content = (
    <div className={`flex items-center justify-between p-3 rounded ${active ? 'bg-blue-100 border-2 border-blue-300' : 'bg-gray-50 border-2 border-gray-300 hover:border-gray-400'}`}>
      <span className={`font-medium ${active ? 'text-gray-900' : 'text-gray-700'}`}>{label}</span>
      {!active && <span className="text-xs text-[#000080] font-bold">View →</span>}
    </div>
  );
      ...
      <div className="p-4 space-y-4 text-sm text-gray-700">
        ...
        <div>
          ...
          <ul className="space-y-1 text-xs">
            <li>• <Link to="/patterns/identity/forgot-password" className="text-[#000080] hover:underline">Forgot password?</Link></li>
            <li>• <Link to="/patterns/identity/account-recovery" className="text-[#000080] hover:underline">Account locked?</Link></li>
            <li>• <Link to="/patterns/identity/auth-error" className="text-[#000080] hover:underline">Login errors?</Link></li>
          </ul>
        </div>
      </div>
    </div>
