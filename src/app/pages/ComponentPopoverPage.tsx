          ...
          <div className="bg-card border border-border rounded-lg shadow-lg overflow-hidden">
            ...
            {closeButton && (
              <button
                ...
                className="absolute top-2 right-2 p-1 text-muted-foreground hover:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-[#005196] rounded"
...
const POPOVER_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'trigger', label: 'Trigger', type: 'text', defaultValue: 'click' },
  { name: 'position', label: 'Position', type: 'text', defaultValue: 'top' },
];
    ...
    <ComponentDocumentation
      ...
      props={[
        ...
        },
        {
          ...
          default: "'click'",
          required: false,
          description: 'Interaction type that opens the popover.',
        },
        {
          name: 'open',
          type: 'boolean',
      ...
      examples={[
        ...
        },
        {
          ...
          code: 'import { Popover } from \'@ux4g/react-core\';\nimport { HelpCircle } from \'lucide-react\';\n\nfunction Example() {\n  return (\n    <div className="inline-flex items-center gap-2">\n      <span className="text-sm text-muted-foreground">Password Requirements</span>\n      <Popover\n        trigger="hover"\n        placement="right"\n        size="sm"\n        content={\n          <div className="p-3">\n            <h4 className="font-semibold text-foreground text-sm mb-2">\n              Password must contain:\n            </h4>\n            <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">\n              <li>At least 8 characters</li>\n              <li>One uppercase letter</li>\n              <li>One lowercase letter</li>\n              <li>One number</li>\n              <li>One special character</li>\n            </ul>\n          </div>\n        }\n      >\n        <button className="text-muted-foreground hover:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-[#005196] rounded-full">\n          <HelpCircle size={18} />\n        </button>\n      </Popover>\n    </div>\n  );\n}',
          preview: (
            <div className="inline-flex items-center gap-2">
              <span className="text-sm text-muted-foreground">Password Requirements</span>
              <PopoverPreview
