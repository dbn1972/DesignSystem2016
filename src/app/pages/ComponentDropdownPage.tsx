            ...
            {items.map((item: any, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className="ml-auto inline-flex items-center justify-center px-2 py-0.5 text-xs font-medium bg-red-50 dark:bg-red-900/200 text-white rounded-full">
                      {item.badge}
                    </span>
                  )}
                </button>
...
const DROPDOWN_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  ...
  { name: 'showDividers', label: 'Show Dividers', type: 'boolean', defaultValue: false },
];
