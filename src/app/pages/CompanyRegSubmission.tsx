...
export default function CompanyRegSubmission() {
  const referenceNumber = "MCA-2026-REG-" + String(Math.floor(100000 + Math.random() * 900000));
    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b-2 border-border">
        <div className="max-w-[1000px] mx-auto px-6 py-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-foreground">Registration Application Submitted</h1>
          <p className="text-sm text-muted-foreground mt-2">Your company registration application is now under review.</p>
        </div>
      </header>
      ...
      <div className="max-w-[1000px] mx-auto px-6 py-8 space-y-5">
        <section className="bg-card border-2 border-border rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-5 text-sm">
            ...
            <Detail label="Entity Type" value="Private Limited Company" />
            <Detail label="Submission Date" value={submittedDate} />
            <Detail label="Current Status" value="Submitted — CIN Pending" />
          </div>
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-3">
            ...
            <Link
              to="/services/company-registration/status-tracker"
        ...
        <section className="bg-blue-50 dark:bg-blue-950/30 border-2 border-blue-300 rounded-lg p-5">
          ...
          <ol className="list-decimal list-inside text-sm text-muted-foreground mt-3 space-y-1">
            <li>Your proposed company name will be verified and approved.</li>
            <li>Submitted documents will be reviewed by the ROC officer.</li>
            <li>Upon approval, a Corporate Identity Number (CIN) will be generated.</li>
            <li>Certificate of Incorporation will be available for download.</li>
          </ol>
        </section>
      </div>
    </div>
