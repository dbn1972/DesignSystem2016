        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {principles.map((principle, index) => (
              <div 
                key={index}
                className="bg-white border border-gray-200 rounded-xl p-8 hover:border-[#000080] transition-colors"
              >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-xl">
            <h3 className="font-semibold text-gray-900 mb-2">Accessibility Note</h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    <th className="text-left px-6 py-4 font-semibold text-gray-900">Style</th>
                    <th className="text-left px-6 py-4 font-semibold text-gray-900">Size</th>
                    <th className="text-left px-6 py-4 font-semibold text-gray-900">Weight</th>
                    <th className="text-left px-6 py-4 font-semibold text-gray-900">Usage</th>
                    <th className="text-left px-6 py-4 font-semibold text-gray-900">Example</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  {typography.map((type, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-gray-600">{type.size}</td>
                      <td className="px-6 py-4 text-gray-600">{type.weight}</td>
                      <td className="px-6 py-4 text-gray-600">{type.usage}</td>
                      <td className="px-6 py-4">
                        <span style={{ fontSize: type.size, fontWeight: type.weight }}>Aa</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="mt-6 p-6 bg-orange-50 border border-orange-200 rounded-xl">
            <h3 className="font-semibold text-gray-900 mb-2">Font Family</h3>
            <p className="text-gray-700">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-xl">
            ...
            <code className="block bg-white px-4 py-3 rounded border border-green-300 text-sm font-mono text-gray-900">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <Grid size={28} />
              <h2 className="text-3xl font-bold text-gray-900">Grid & Layout</h2>
            </div>
            <p className="text-lg text-gray-600">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-1">320px - 767px</p>
              <p className="text-xs text-gray-500">Stack content vertically</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">Tablet</h3>
              <p className="text-sm text-gray-600 mb-1">768px - 1023px</p>
              <p className="text-xs text-gray-500">2-column layouts</p>
            </div>
            <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
              <h3 className="font-semibold text-gray-900 mb-2">Desktop</h3>
              <p className="text-sm text-gray-600 mb-1">1024px+</p>
              <p className="text-xs text-gray-500">Full grid layouts</p>
            </div>
          </div>
        </div>
      </section>
