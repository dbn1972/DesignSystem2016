...
const TABLE_CONTROLS: PlaygroundControl[] = [
  {
    name: 'striped',
    label: 'Striped',
    type: 'boolean',
  ...
  return (
    <ComponentPlayground
      ...
      codeTemplate={(v) => {
        ...
        return `<Table${props.length ? ' ' + props.join(' ') : ''} />`;
      }}
    />
  );
}
      ...
      props={[
        {
          ...
          type: 'TableColumn<T>[]',
          required: true,
          description: 'Table column definitions. Each column has key, header, optional render/accessor, sortable, width, and align.',
        },
        {
          name: 'data',
          type: 'T[]',
          required: true,
          description: 'Table row data array.',
        },
        {
          name: 'rowKey',
        ...
        },
        {
          ...
          type: 'SortState',
          required: false,
          description: 'Controlled sort state ({ columnKey, direction }).',
        },
        {
          name: 'onSortChange',
