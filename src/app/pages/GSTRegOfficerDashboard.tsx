...
export default function GSTRegOfficerDashboard() {
  const stats = {
    totalCases: 48,
    pendingReview: 14,
    underReview: 8,
    clarificationNeeded: 6,
    completedToday: 7,
  ...
  const recentActivity = [
    { action: "GSTIN Generated", refNumber: "CBIC-2026-GST-876543", applicant: "Priya Sharma", time: "15 minutes ago", type: "success" as const },
    { action: "Clarification Requested", refNumber: "CBIC-2026-GST-875421", applicant: "Rajesh Kumar", time: "45 minutes ago", type: "warning" as const },
    { action: "New Application Assigned", refNumber: "CBIC-2026-GST-874112", applicant: "Anita Desai", time: "1 hour ago", type: "info" as const },
    { action: "Documents Verified", refNumber: "CBIC-2026-GST-873098", applicant: "Vikram Singh", time: "2 hours ago", type: "success" as const },
  ];

  const urgentCases = [
    { refNumber: "CBIC-2026-GST-872567", applicant: "Meera Patel", registrationType: "Regular", daysWaiting: 9 },
    { refNumber: "CBIC-2026-GST-871234", applicant: "Arjun Reddy", registrationType: "Composition", daysWaiting: 8 },
    { refNumber: "CBIC-2026-GST-870987", applicant: "Kavita Joshi", registrationType: "Casual", daysWaiting: 7 },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-muted-foreground">GST Officer Portal</div>
                <h1 className="text-2xl font-bold text-foreground">GST Registration Dashboard</h1>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-muted-foreground">Logged in as</div>
              <div className="font-bold text-foreground">Officer Amit Verma</div>
              <div className="text-xs text-muted-foreground">CBIC Division, Delhi</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <StatCard icon={<Briefcase size={28} />} label="Total Cases" value={stats.totalCases} color="blue" trend="+5 from yesterday" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <MetricCard icon={<Clock size={24} />} label="Avg. Processing" value={stats.avgProcessingTime} subtext="Target: 7 days" color="blue" />
              ...
              <div className="p-6 space-y-4">
                {urgentCases.map((c, i) => (
                  <div key={i} className="bg-red-50 dark:bg-red-950/30 border-2 border-red-300 rounded p-4">
                    ...
                    <div className="text-xs text-muted-foreground mb-2">{c.registrationType}</div>
      ...
      <footer className="bg-card border-t-2 border-border mt-24">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-8">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div>GST Registration Service • GST Officer Portal</div>
            <div>Dashboard</div>
          </div>
        </div>
      </footer>
