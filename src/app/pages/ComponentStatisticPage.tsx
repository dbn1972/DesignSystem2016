...
const StatisticPreview = ({
  ...
  if (layout === 'card') {
    return (
      <div className="border border-border rounded-lg p-6 bg-card shadow-sm" {...props}>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className={'text-muted-foreground mb-2 ' + labelSizeClasses}>{label}</div>
          ...
          {icon && (
            <div className={'p-3 rounded-lg bg-background ' + variantColors[variant]}>
              {icon}
            </div>
          )}
        </div>
  ...
  return (
    <div className="inline-block" {...props}>
      <div className={'text-muted-foreground mb-1 ' + labelSizeClasses}>{label}</div>
    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-6">
      <div className="flex items-center justify-center min-h-[160px] rounded-xl border-2 border-dashed border-border bg-background p-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">Live Statistic preview with current settings</p>
          <div className="flex flex-wrap gap-2 justify-center">
            {showTrend && <span className="px-2 py-0.5 rounded-full text-xs bg-[#005196]/10 text-[#005196] font-medium">showTrend</span>}
          </div>
        </div>
      </div>
...
export default function ComponentStatisticPage() {
  return (
    <ComponentDocumentation
      ...
      preview={
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#005196]/10 text-[#005196] text-2xl font-bold">St</div>
          <p className="text-sm text-muted-foreground">Statistic component in its default state</p>
        </div>
      }
        ...
        <>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-green-700 mb-3 flex items-center gap-2">
                  ...
                  Do use Statistic when
                </h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Key metric displays</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Dashboard summary numbers</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>KPI indicators</li>
                  <li className="flex items-start gap-2"><span className="text-green-600 mt-0.5">•</span>Trend and comparison values</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Charts and graphs — use ChartLibrary</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Tabular data — use Table</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Progress indicators — use Progress</li>
                  <li className="flex items-start gap-2"><span className="text-red-600 mt-0.5">•</span>Status labels — use Badge</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="border-2 border-green-200 rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                  <p className="text-sm text-muted-foreground">Place key metrics at the top of dashboards — they are noticed 90% of the time.</p>
                </div>
              </div>
              <div className="border-2 border-red-200 rounded-lg overflow-hidden">
                <div className="bg-red-50 px-4 py-2 text-sm font-bold text-red-800">✗ Don&apos;t</div>
                <div className="p-4">
                  <p className="text-sm text-muted-foreground">Don&apos;t use Statistic for charts or graphs — use ChartLibrary instead.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <a href="/components/chartlibrary" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
                <h3 className="font-semibold text-foreground mb-1">ChartLibrary</h3>
                <p className="text-sm text-muted-foreground">For data visualization</p>
              </a>
              <a href="/components/card" className="block p-4 border border-border rounded-lg hover:border-primary transition-colors">
                ...
                <p className="text-sm text-muted-foreground">For metric containers</p>
              </a>
            ...
            <div className="space-y-4">
                <div className="border-l-2 border-primary pl-4">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added trend indicator</li>
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Added prefix/suffix support</li>
                  </ul>
                </div>
                <div className="border-l-2 border-primary pl-4">
                  <div className="flex items-center gap-3 mb-1">
                  ...
                  <ul className="space-y-1">
                    <li className="text-sm text-muted-foreground flex items-start gap-2"><span className="text-primary mt-1">•</span>Initial release with label and value</li>
                  </ul>
                </div>
            </div>
          </section>
          ...
          <section className="bg-card rounded-lg border border-border p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                <h3 className="font-semibold text-foreground mb-1 text-sm">Dashboard metrics placement</h3>
                <p className="text-sm text-muted-foreground">Key metrics placed at the top of dashboards are noticed 90% of the time vs 40% when placed below the fold (NNG).</p>
              </div>
            </div>
          </section>
        </>
