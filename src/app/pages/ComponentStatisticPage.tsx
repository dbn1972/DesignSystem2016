    ...
    <ComponentDocumentation
      ...
      props={[
        ...
        },
        {
          ...
          type: 'ReactNode',
          required: false,
          description: 'Content before the value (e.g., ₹, $).',
        },
        {
          name: 'suffix',
          type: 'ReactNode',
          required: false,
          description: 'Content after the value (e.g., %, units).',
        },
        {
          name: 'trend',
          type: '{ value: number; label?: string }',
          required: false,
          description: 'Trend indicator with numeric value and optional label.',
        },
        {
          name: 'icon',
          type: 'ReactNode',
          required: false,
          description: 'Icon to display alongside the statistic.',
        },
        {
          name: 'className',
          type: 'string',
