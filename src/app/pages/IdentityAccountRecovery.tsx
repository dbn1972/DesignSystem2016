                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  {step === "locked" && (
                    <div>
                      ...
                      <h1 className="text-3xl font-bold text-gray-900 mb-3 text-center">Account Recovery Required</h1>
                      ...
                      <div className="p-6 bg-red-50 border-2 border-red-200 rounded-lg mb-8">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm">
                            <div className="font-bold text-gray-900 mb-2">Why is my account locked?</div>
                      ...
                      <div className="space-y-4 mb-8">
                        <div className="flex items-start gap-3 p-4 border-2 border-gray-300 rounded-lg">
                          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <span className="font-bold text-blue-700">1</span>
                          </div>
                          <div>
                            <div className="font-bold text-gray-900 mb-1">Verify Your Identity</div>
                            <div className="text-sm text-gray-700">Provide personal information to confirm your identity</div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3 p-4 border-2 border-gray-300 rounded-lg">
                          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                          ...
                          <div>
                            <div className="font-bold text-gray-900 mb-1">Submit Supporting Documents</div>
                            <div className="text-sm text-gray-700">Upload government ID proof for verification</div>
                          </div>
                        </div>
                        <div className="flex items-start gap-3 p-4 border-2 border-gray-300 rounded-lg">
                          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                          ...
                          <div>
                            <div className="font-bold text-gray-900 mb-1">Wait for Manual Review</div>
                            <div className="text-sm text-gray-700">Our team will verify and unlock your account within 3-5 business days</div>
                          </div>
                        </div>
                      </div>
                  ...
                  {step === "identity" && (
                    <div>
                      ...
                      <form className="space-y-6">
                        ...
                        <div>
                          <label htmlFor="dob" className="block text-sm font-bold text-gray-900 mb-2">
                  ...
                  {step === "documents" && (
                    <div>
                      <h1 className="text-3xl font-bold text-gray-900 mb-3">Submit Identity Proof</h1>
                      <p className="text-gray-600 mb-8">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-3">
                          {["Aadhaar Card", "PAN Card", "Voter ID", "Driving License", "Passport"].map((doc) => (
                            <label key={doc} className="flex items-center gap-3 p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-[#000080] hover:bg-blue-50 transition-colors">
                              <input
                                type="radio"
                                name="documentType"
                                value={doc}
                      ...
                      {recoveryData.documentType && (
                        <>
                          <div className="mb-6">
                            <label htmlFor="documentNumber" className="block text-sm font-bold text-gray-900 mb-2">
                            ...
                            <input
                              ...
                              className="w-full px-4 py-4 border-2 border-gray-300 rounded-lg text-gray-900 focus:border-[#000080] focus:outline-none text-lg"
                          ...
                          <div className="mb-8">
                            ...
                            <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center bg-gray-50 hover:border-[#000080] hover:bg-blue-50 transition-colors cursor-pointer">
                              <FileText size={48} className="text-gray-400 mx-auto mb-4" />
                              <div className="font-bold text-gray-900 mb-2">Click to upload or drag and drop</div>
                  ...
                  {step === "review" && (
                    <div>
                      <h1 className="text-3xl font-bold text-gray-900 mb-3">Review Your Submission</h1>
                      <p className="text-gray-600 mb-8">
                      ...
                      <div className="p-6 bg-blue-50 border-2 border-blue-200 rounded-lg mb-8">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm text-gray-700">
                            <div className="font-bold text-gray-900 mb-2">What happens next?</div>
                  ...
                  {step === "success" && (
                    <div className="text-center">
                      ...
                      <h1 className="text-3xl font-bold text-gray-900 mb-3">Recovery Request Submitted</h1>
                      <p className="text-gray-600 mb-8">
                      ...
                      <div className="p-6 bg-gray-100 border-2 border-gray-300 rounded-lg mb-8 text-left">
                        <div className="font-bold text-gray-900 mb-3">Reference Number</div>
                        <div className="text-2xl font-bold text-[#000080] mb-4">REC-2026-04-XXXXX</div>
                        <div className="text-sm text-gray-600">Save this number for tracking your request</div>
                      </div>
                      ...
                      <div className="p-6 bg-blue-50 border-2 border-blue-200 rounded-lg mb-8 text-left">
                        <div className="flex items-start gap-3">
                          <Info size={20} className="text-blue-600 flex-shrink-0 mt-0.5" />
                          <div className="text-sm text-gray-700">
                            <div className="font-bold text-gray-900 mb-2">Track Your Request</div>
              ...
              <div className="border-t-2 border-gray-300 bg-gray-50 px-12 py-6">
                <div className="max-w-2xl mx-auto">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-bold text-gray-900 mb-2">Need Assistance?</div>
...
function RecoveryStep({ number, label, active, completed }: { number: number; label: string; active: boolean; completed: boolean }) {
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className={`text-xs font-medium text-center ${active ? 'text-gray-900' : 'text-gray-500'}`}>{label}</div>
    </div>
  );
}
...
function TimelineItem({ step, label, time }: { step: string; label: string; time: string }) {
  return (
    <div className="flex items-start gap-3">
      <div className="w-6 h-6 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center flex-shrink-0 font-bold text-xs">
        {step}
      </div>
