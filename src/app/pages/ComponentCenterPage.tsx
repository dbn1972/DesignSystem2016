...
const CENTER_PLAYGROUND_CONTROLS: PlaygroundControl[] = [
  { name: 'minHeight', label: 'Min Height', type: 'text', defaultValue: '200px' },
  { name: 'inline', label: 'Inline', type: 'boolean', defaultValue: false },
  { name: 'padding', label: 'Padding', type: 'text', defaultValue: 'md' },
];
