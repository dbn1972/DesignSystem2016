...
export default function DashboardOverview() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-br from-indigo-50 via-white to-purple-50 border-b-2 border-gray-300">
        <div className="max-w-[1400px] mx-auto px-12 py-12">
          ...
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 border-2 border-gray-300 rounded flex items-center justify-center">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
                ...
                <div className="grid grid-cols-3 gap-6">
                  <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
                    <h3 className="font-bold text-gray-900 mb-3">User Benefits</h3>
                  ...
                  <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-6">
                    <h3 className="font-bold text-gray-900 mb-3">Service Benefits</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
            ...
            <section>
              ...
              <div className="bg-red-50 border-2 border-red-300 rounded-lg p-8">
                <div className="flex items-start gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-2">Critical Considerations</h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-bold text-gray-900 mb-3">Authentication & Access</h4>
                    <ul className="space-y-2 text-sm text-gray-700">
            ...
            <section>
              ...
              <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-8">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 mb-3">Inclusive Design</h3>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-600 mt-0.5 flex-shrink-0" />
  ...
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden sticky top-24">
      ...
      <div className="p-4 space-y-2 text-sm">
        ...
        <a href="#privacy-security" className="block text-gray-700 hover:text-[#000080]">Privacy & Security</a>
...
function Resources() {
  return (
    <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="p-4 space-y-2 text-sm">
        <Link to="/patterns/dashboard" className="flex items-center gap-2 text-gray-700 hover:text-[#000080]">
          <ArrowRight size={14} />
