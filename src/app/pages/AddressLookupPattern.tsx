          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <h1 className="text-5xl font-bold text-gray-900">Address Lookup</h1>
              </div>
            </div>
            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border-2 border-gray-300 rounded focus:border-[#000080] focus:outline-none"
                      maxLength={6}
                    />
                    <button
                      onClick={handlePincodeLookup}
                      disabled={loading || pincode.length !== 6}
                      className="px-6 py-3 bg-[#000080] text-white rounded font-bold hover:bg-blue-900 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      {loading ? (
                        <>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border-2 rounded ${
                        addressData ? "border-green-500 bg-green-50" : "border-gray-300 bg-gray-50"
                      }`}
                      readOnly
                  ...
                  <div>
                    <label className="block font-bold text-gray-900 mb-2">Area/Locality</label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  ></textarea>
                  <div className="text-xs text-gray-600 mt-1">This field requires manual entry</div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-6">
              <section>
                ...
                <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                  <h3 className="font-bold text-gray-900 mb-4">India Post Pincode API</h3>
  ...
  "PostOffice": [
    {
      ...
      "Country": "India"
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">Accessibility Considerations</h2>
            ...
            <div className="sticky top-8 space-y-6">
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    <div className="text-xs text-gray-600 mb-1">Accuracy Improvement</div>
                    <div className="font-bold">95%+ reduction in errors</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-600 mb-1">API Dependency</div>
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <div className="text-xs text-gray-600">Form completion time</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-green-600 mb-1">-95%</div>
                    <div className="text-xs text-gray-600">Address errors</div>
                  </div>
                  <div>
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  <Link to="/patterns/data-input/map-input" className="block text-sm text-[#000080] hover:underline">
                    → Map-based Input
                  </Link>
