            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-bold text-gray-900">Fee Payment Flow</h1>
                </div>
              </div>
...
function StateIndicator({ currentState }: { currentState: FlowState }) {
  const stateConfig = {
    ...
    "help": { label: "Help", color: "bg-gray-100 text-gray-700" }
  };
        ...
        <div className="bg-white px-8 py-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Application Fee Payment</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="border-t-2 border-gray-300 pt-3 mt-3">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-gray-900 text-lg">Total Amount Payable</span>
                  <span className="font-bold text-gray-900 text-2xl">₹{feeDetails.totalAmount.toLocaleString('en-IN')}</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-5 text-center">
          ...
          <div className="text-4xl font-bold text-gray-900">₹{feeDetails.totalAmount.toLocaleString('en-IN')}</div>
          <div className="text-xs text-gray-600 mt-2">{feeDetails.serviceName}</div>
        </div>
    ...
    <>
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <div className="font-bold text-gray-900">{feeDetails.serviceName}</div>
            </div>

            {/* Application ID */}
            <div>
              <div className="text-xs text-gray-600 mb-2">Application ID</div>
              <div className="font-bold text-gray-900 font-mono">{feeDetails.applicationId}</div>
            </div>

            {/* Applicant */}
            <div>
              <div className="text-xs text-gray-600 mb-2">Applicant Name</div>
              <div className="font-bold text-gray-900">{feeDetails.applicantName}</div>
            </div>
        ...
        <div className="flex items-center gap-4 pt-4">
          ...
          <button
            onClick={onConfirm}
            className="flex-1 px-6 py-4 bg-[#138808] text-white font-bold rounded text-sm hover:bg-green-700 transition-colors flex items-center justify-center gap-2"
          >
            <Lock size={18} />
  ...
  return (
    <div className="p-12">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-3">Processing Payment</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border-2 border-gray-300 rounded p-4">
                ...
                <div className="font-bold text-gray-900 text-xl">₹{feeDetails.totalAmount.toLocaleString('en-IN')}</div>
              </div>
              <div className="bg-white border-2 border-gray-300 rounded p-4">
                <div className="text-xs text-gray-600 mb-1">Payment Date & Time</div>
                <div className="font-bold text-gray-900 text-sm">{paymentTimestamp}</div>
              </div>
            </div>
      ...
      <div className="p-8">
        ...
        <div className="bg-white border-2 border-gray-300 rounded-lg p-8 mb-6">
          ...
          <div className="text-center mb-8 pb-6 border-b-2 border-gray-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Government of India</h3>
            <p className="text-sm text-gray-600">Ministry of External Affairs • Passport Seva</p>
          ...
          <div className="space-y-6">
            ...
            <div className="border-t-2 border-gray-300 pt-4">
              <div className="font-bold text-gray-900 mb-3">Fee Breakdown</div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-700">Passport Application Fee</span>
                  <span className="font-bold text-gray-900">₹{feeDetails.baseFee.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-700">Service Tax (18%)</span>
                  <span className="font-bold text-gray-900">₹{feeDetails.serviceTax.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-700">Payment Processing Fee</span>
                  <span className="font-bold text-gray-900">₹{feeDetails.processingFee.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between pt-3 border-t-2 border-gray-300">
                  <span className="font-bold text-gray-900 text-lg">Total Amount Paid</span>
                  <span className="font-bold text-gray-900 text-xl">₹{feeDetails.totalAmount.toLocaleString('en-IN')}</span>
                </div>
              </div>
            </div>

            {/* Footer Note */}
            <div className="border-t-2 border-gray-300 pt-4 text-xs text-gray-600">
              <p className="mb-2">
...
function ReceiptRow({ label, value, highlight }: { label: string; value: string; highlight?: boolean }) {
  return (
    <div className={`flex justify-between items-start py-2 ${highlight ? 'bg-blue-50 -mx-4 px-4 rounded' : ''}`}>
      ...
      <span className={`text-sm text-right ${highlight ? 'font-bold text-gray-900 font-mono' : 'font-bold text-gray-900'}`}>
        {value}
      </span>
    </div>
  );
    ...
    <>
      <div className="bg-gray-100 border-b-2 border-gray-300 px-8 py-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Payment Help</h2>
            <p className="text-sm text-gray-700">
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-5">
          <div className="flex items-start gap-3">
            <Info size={20} className="text-[#000080] flex-shrink-0 mt-0.5" />
            <div className="text-sm text-gray-700 text-left">
              <p className="font-bold text-gray-900 mb-2">Need Further Assistance?</p>
...
function StateExplainer({ currentState }: { currentState: FlowState }) {
  ...
  return (
    <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-5">
      <h3 className="font-bold text-gray-900 mb-3">Current State: {config.label}</h3>
      <p className="text-sm text-gray-700 leading-relaxed">
        {config.description}
      </p>
    </div>
...
function SecurityNotice() {
  return (
    <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-5">
      <h3 className="font-bold text-gray-900 mb-3">Security Notice</h3>
      <div className="space-y-2 text-sm text-gray-700">
