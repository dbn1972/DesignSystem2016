            ...
            <div className="max-w-4xl">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-5xl font-bold text-gray-900">Suggest Improvement</h1>
                </div>
              </div>
            ...
            <div className="bg-white border-2 border-gray-300 rounded-lg p-8">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      />
                      <div>
                        <span className="font-bold text-gray-900">Vote for your suggestion</span>
                        <p className="text-sm text-gray-600">Popular suggestions are prioritized for implementation</p>
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    <button
                      type="submit"
                      className="px-8 py-3 bg-green-600 text-white rounded font-bold hover:bg-green-700"
                    >
                      Submit Suggestion
                    </button>
                    <button
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Thank You for Your Suggestion!</h3>
