...
const SWITCH_CONTROLS: PlaygroundControl[] = [
  {
    name: 'disabled',
    label: 'Disabled',
    type: 'boolean',
  ...
  return (
    <ComponentPlayground
      ...
      codeTemplate={(v) => {
        ...
        return `<Switch${props.length ? ' ' + props.join(' ') : ''} />`;
      }}
    />
  );
}
    ...
    <ComponentDocumentation
      ...
      props={[
        ...
        },
        {
          ...
          default: "'md'",
          required: false,
          description: 'Size variant of the switch control.',
        },
        {
          name: 'children',
          type: 'ReactNode',
          required: false,
          description: 'Content to render as the switch label (alternative to label prop).',
        },
        {
          name: 'disabled',
          type: 'boolean',
