...
export default function TradeLicenseOfficerDashboard() {
  const stats = {
    totalCases: 56,
    pendingReview: 18,
    underReview: 10,
    clarificationNeeded: 7,
    completedToday: 4,
  ...
  const recentActivity = [
    { action: "License Issued", refNumber: "MC-2026-TL-876543", applicant: "Priya Sharma", time: "30 minutes ago", type: "success" as const },
    { action: "Inspection Scheduled", refNumber: "MC-2026-TL-875421", applicant: "Rajesh Kumar", time: "1 hour ago", type: "warning" as const },
    { action: "New Application Assigned", refNumber: "MC-2026-TL-874112", applicant: "Anita Desai", time: "2 hours ago", type: "info" as const },
    { action: "Documents Verified", refNumber: "MC-2026-TL-873098", applicant: "Vikram Singh", time: "3 hours ago", type: "success" as const },
  ];

  const urgentCases = [
    { refNumber: "MC-2026-TL-872567", applicant: "Meera Patel", category: "Food & Beverage", daysWaiting: 28 },
    { refNumber: "MC-2026-TL-871234", applicant: "Arjun Reddy", category: "Healthcare", daysWaiting: 25 },
    { refNumber: "MC-2026-TL-870987", applicant: "Kavita Joshi", category: "Manufacturing", daysWaiting: 22 },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm text-muted-foreground">Municipal Inspector Portal</div>
                <h1 className="text-2xl font-bold text-foreground">Trade License Dashboard</h1>
              </div>
            </div>
            <div className="text-right">
              <div className="text-sm text-muted-foreground">Logged in as</div>
              <div className="font-bold text-foreground">Inspector Ramesh Gupta</div>
              <div className="text-xs text-muted-foreground">Municipal Corporation, Zone 3</div>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <StatCard icon={<CheckCircle size={28} />} label="Completed Today" value={stats.completedToday} color="green" trend="Keep it up!" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          <MetricCard icon={<Clock size={24} />} label="Avg. Processing" value={stats.avgProcessingTime} subtext="Target: 15 days" color="blue" />
              ...
              <div className="p-6 space-y-4">
                {urgentCases.map((c, i) => (
                  <div key={i} className="bg-red-50 dark:bg-red-950/30 border-2 border-red-300 rounded p-4">
                    ...
                    <div className="text-xs text-muted-foreground mb-2">{c.category}</div>
      ...
      <footer className="bg-card border-t-2 border-border mt-24">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-8">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div>Trade License Service • Municipal Inspector Portal</div>
            <div>Dashboard</div>
          </div>
        </div>
      </footer>
