      ...
      <main className="max-w-[1400px] mx-auto px-4 sm:px-8 lg:px-12 py-8 lg:py-12 space-y-8">
        <section>
          <div className="border-l-4 border-[#000080] pl-4 mb-6">
            ...
            <p className="text-gray-600">Review the key instructions before starting your application.</p>
          </div>
        ...
        <section className="bg-white border-2 border-gray-300 rounded-lg overflow-hidden">
          <div className="bg-gray-100 border-b-2 border-gray-300 px-6 py-5">
            <h3 className="text-xl font-bold text-gray-900">Application Instructions</h3>
          </div>
        ...
        <section className="bg-white border-2 border-gray-300 rounded-lg p-6 sm:p-8">
          <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-5 mb-5">
            ...
            <p className="text-sm text-gray-700">By continuing, you confirm all information provided is accurate and can be verified.</p>
          </div>
          ...
          <Link
            ...
            className={`w-full block px-8 py-4 text-white font-bold rounded text-center transition-colors ${
              acceptedTerms ? "bg-[#138808] hover:bg-green-700" : "bg-gray-400 pointer-events-none"
            }`}
        ...
        >
          <div className="mt-2 flex items-center gap-4 text-sm">
            <Link to={helpPath} className="font-bold text-[#000080] hover:underline">Visit Help Center</Link>
            {codeDownloadPath && (
...
function InstructionStep({
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="w-10 h-10 bg-[#000080] text-white rounded-full flex items-center justify-center flex-shrink-0 font-bold">{number}</div>
      <div>
